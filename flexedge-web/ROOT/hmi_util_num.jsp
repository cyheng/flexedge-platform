    ...
    <table style="width:100%;height:100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF" align="center">
                <table id="kp_vals" align="center" style="width:100%;height:100%" border="0" cellspacing="0"
                       cellpadding="0">
                    ...
                    <tr align="left" valign="middle">
                        ...
                        <td><input class=button type=button value="<lan:g>close</lan:g>" name="Submit222"
                                   onclick="win_close()"></td>
                    </tr>
                    <tr align="left" valign="middle">
                        ...
                        <td><input type=button onclick="do_ok()" value="<lan:g>ok</lan:g>"
