...
<form class="layui-form" onsubmit="return false;">
    <table style="width:100%;height:40px;border-bottom: 1px solid #e6e6e6;">
        <tr>
            <td style="width:70%;padding-left:5px;font-weight: bold;"><wbt:g>evt_alert,list</wbt:g> <span
                    id="top_tt"><%=title %></span></td>
...
<script type="text/html" id="row_toolbar">
    <div class="layui-btn-group">
        <button type="button" class="layui-btn layui-btn-xs layui-btn-primary" lay-event="detail"><i
...
<script>
    ...
    function render_tb() {
        ...
        cols.push({
            title: '<wbt:g>dur_tm</wbt:g>', width: '10%', templet: function (ob) {
                if (!ob.dur_ms) return "";
