...
<%
    ...
    if (owner_def != null) {// use UADev as top res_ref_id
...
<div style="z-index:65534;position: absolute;right:0px;top:0px">
    ...
    <div id="oper_alert" class="oper" style="top:180px;border:1px solid;border-color:#469424;background-color: #1e1e1e;"
         title="show alerts"><i id="oper_alert_i" class="fa fa-bell fa-3x"></i></div>
    <div id="oper_data" class="oper"
         style="top:230px;border:1px solid;border-color:#469424;background-color: #1e1e1e;color:#83ec21"
         title="show tags data"><i id="oper_data_i" class="fa fa-list-alt fa-3x"></i></div>
    <div id="oper_ui" class="oper"
         style="top:280px;border:1px solid;border-color:#469424;background-color: #1e1e1e;color:#ffd898"
         title="show UI Dialog List"><i class="fa fa-area-chart fa-3x"></i></div>

    <div id="alert_list_c" style="display:none;width:700px" class="pwin">
 		<span class="op">
 		    <button type="button" class="layui-btn layui-btn-xs layui-btn-warn" onclick="show_alerts_his()"
                    title="Show Alerts History"><lan:g>history_d</lan:g></button>
			<button type="button" class="layui-btn layui-btn-xs layui-btn-danger" onclick="hide_alerts()"><i
    ...
    <div id="data_list_c" style="display:none;top:230px;width:800px;" class="pwin">
 		<span class="op">
			<button type="button" class="layui-btn layui-btn-xs layui-btn-danger" onclick="hide_datas()"
                    title="hidde"><i class="fa fa-times"></i></button>
		</span>
                    ...
                    <td>
                        <%
                            ...
                            if (rec_mgr != null && rec_mgr.checkTagCanRecord(tag)) {
                                ...
                                if (rtp != null) {
                        %>
                        <button onclick="rec_tag_show('<%=tmppath %>','<%=tag.getTitle() %> [<%=tmppath %>]')"
                                title="show inner recorded history" style="background-color:#4def3e">&nbsp;<i
                        ...
                        %>
                        <button onclick="show_data_his('<%=outtp %>','<%=outid %>','<%=tagp%>','<%=tt %>')"
                                title="show outer data source history - <%=outtpt%>">&nbsp;<i
                                class="fa fa-line-chart"/></i>&nbsp;
                        </button>
                        <%
                                }
    ...
    <div id="ui_list_c" style="display:none;top:280px;width:500px;height:280px" class="pwin">
 		<span class="op">
			<button type="button" class="layui-btn layui-btn-xs layui-btn-danger" onclick="hide_uis()" title="hidde"><i
                    class="fa fa-times"></i></button>
		</span>
