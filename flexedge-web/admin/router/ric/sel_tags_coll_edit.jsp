...
<form class="layui-form" action="" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="overflow: auto;width:350px;">
            <textarea style="width:100%;height:50px;" id="r_tags" readonly="readonly" onclick="sel_tags('r')"
                      class="layui-input"><%=out_tagtxt %></textarea>
        </div>
                ...
                <%
                    for (RouterInnCollator.OutStyle outs : RouterInnCollator.OutStyle.values()) {
                        ...
                        if (os != null && os.getInt() == v)
                            chk = "selected";
                %>
                <option value="<%=v%>" <%=chk %>><%=outs.getTitle() %>
                </option>
                <%
                    }
                %>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="overflow: auto;width:350px;">
            <textarea style="width:100%;height:50px;" id="w_tags" readonly="readonly" onclick="sel_tags('w')"
                      class="layui-input"><%=in_tagtxt %></textarea>
        </div>
        <div class="layui-form-mid">
            <button onclick="sel_tags('w')">...</button>
        </div>
    </div>
    <div class="layui-form-item">
