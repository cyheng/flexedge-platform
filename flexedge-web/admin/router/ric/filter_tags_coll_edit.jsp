...
<%@ page import="org.json.*,
                 ...
                 cn.doraro.flexedge.core.filter.*,
...
<form class="layui-form" action="" onsubmit="return false;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 150px;">
            <input type="checkbox" id="en" name="en" <%=chk_en%> lay-skin="switch" lay-filter="enable"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 100px;">
            <input type="number" id="out_intv" name="out_intv" value="<%=out_intv%>" autocomplete="off"
                   class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline " id="filter_list" style="width:250px;">
            <input type="text" id="sub_root_path" name="sub_root_path" value="<%=sub_root_path %>" readonly
                   autocomplete="off" class="layui-input" onclick="sel_sub_root(this)">
        </div>
        <div class="layui-form-mid"><w:g>tag_inc_sys</w:g></div>
        <div class="layui-input-inline" style="width:50px;">
            <input type="checkbox" id="tag_inc_sys" name="tag_inc_sys" lay-text=""
                   lay-skin="primary" <%=(tag_inc_sys?"checked":"") %>>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:50px;">
            <input type="checkbox" id="c_tps_en" name="c_tps_en" lay-skin="switch" lay-filter="c_tps_en"
                   class="layui-input" <%=(c_tps_en ?"checked":"") %> >
        </div>
        <div class="layui-input-inline" style="width:400px;">
            ...
            %><%=tpt %><input type="checkbox" id="c_tps_<%=tp %>" name="c_tps" value="<%=tp %>"
                              lay-skin="primary"  <%=(c_tps.contains(tp) ?"checked":"") %> <%=disabled %>>
            <%
                }
            %>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid"><w:g>en_filter</w:g>:</div>
        <div class="layui-input-inline" style="width:50px;">
            <input type="checkbox" id="c_exts_en" name="c_exts_en" lay-skin="switch" lay-filter="c_exts_en"
                   class="layui-input" <%=(c_exts_en?"checked":"") %>>
        </div>
        <div class="layui-input-inline" style="width:400px;border:0px solid;">
            ...
            %><%=pd.getPropTitle() %><input type="checkbox" id="c_exts_<%=pd.getPropName() %>" name="c_exts"
                                            lay-skin="primary"
                                            value="<%=nn %>" <%=(c_exts.contains(nn) ?"checked":"") %>><%
                }
            }
        %>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid"><w:g>en_filter</w:g>:</div>
        <div class="layui-input-inline" style="width:50px;">
            <input type="checkbox" id="tag_exts_en" name="tag_exts_en" lay-skin="switch" lay-filter="tag_exts_en"
                   class="layui-input" <%=(tag_exts_en?"checked":"") %>>
        </div>
        <div class="layui-input-inline" style="width:400px;">
            <%
                if (pds_tag != null) {
                    for (SubFilteredTree.PropDef pd : pds_tag) {
                        String nn = pd.getPropName();
            %><%=pd.getPropTitle() %><input type="checkbox" id="tag_exts_<%=pd.getPropName() %>" name="tag_exts"
                                            value="<%=nn %>"
                                            lay-skin="primary" <%=(tag_exts.contains(nn) ?"checked":"") %>><%
                }
            }
        %>
        </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        let sub_f_t = {
            sub_root_path: sub_root_path, c_tps_en: c_tps_en, c_tps: c_tps, c_exts_en: c_exts_en, c_exts: c_exts,
