...
<div class="top " style="background-color: #007ad4;color:#ffffff;">
    ...
    <div class="top_toolbox top_tool" style="left:40%;width:120px">
        <span id='share_run' onclick='clk_share_run()' title="<wbt:g>share,prj</wbt:g>"><i id=''
                                                                                           class='fa fa-share-alt-square fa-lg'></i></span>
        <span id='task_run' onclick='clk_task_run()' title="<wbt:g>task,mgr</wbt:g>"><i id='task_run_icon'
                                                                                        class='fa fa-circle-notch fa-lg'></i></span>
        <span id='alert' onclick='clk_alert_mgr()' title="<wbt:g>alert,mgr</wbt:g>"><i class="fa fa-bell  fa-lg"
                                                                                       id="alert_icon"/></i></span>
        <%--
    ...
    <div class="top_toolbox top_tool" style="left:60%;width:110px;">
        <span id="prj_btn_start" style="color:grey" title="start project" onclick="prj_run(true)"><i
                class="fa fa-play fa-lg"></i></span>
        &nbsp;&nbsp;&nbsp;
        <span id="prj_btn_stop" style="color:grey" title="stop project" onclick="prj_run(false)"><i
    ...
    <div class="top_toolbox top_tool" style="left:70%;width:210px;">
        <span id="show_remote_station" style="color:#76d170" title="manager remote station"
              onclick="show_remote_station()">Remote Station <i class="fa-solid fa-satellite-dish fa-lg"></i></span>
    </div>
    <%
        }
    %>
    <div class="top_toolbox" style="right:10px;width:180px;color:#fff5e2;">
        <button class="layui-btn layui-btn-primary layui-btn-xs  <%=("en".equals(using_lan)?"layui-btn-normal":"") %>"
                onclick="chg_lan('en')">EN
        </button>
        <button class="layui-btn layui-btn-primary layui-btn-xs <%=("cn".equals(using_lan)?"layui-btn-normal":"") %>"
                onclick="chg_lan('cn')">CN
        </button>
        &nbsp;&nbsp;<span onclick="open_doc()"><i
...
<div class='hj-wrap' style="opacity: 1.0;">
            ...
            <div style="width:75%;height:100%;float:left;overflow:hidden;border:solid 0px;border-color: #cccccc;">
                <div id="conn" style="width:110%;height:100%;float:left;overflow:auto;">
                    <div class="subitem" v-for="connector in connectors" style="width:91%;">
                        <div class="subitem_toolbar" v-bind:id="'cp_'+connector.id" v-bind:cp_id="connector.id"
                             v-bind:cp_tp="connector.tp">
                                    ...
                                    <td width="90%" style="white-space: nowrap;" v-bind:title="connector.static_txt">
                                        <%--
											<span style="left:20px;" id="btn_left_showhidden">&nbsp;&nbsp;<i class="fa fa-chevron-down"></i>&nbsp;&nbsp;</span>
											 --%>
                                        &nbsp;&nbsp;<span
                                            style="left:5px;width:15px;height:15px;background-color: grey;"
                                            v-bind:id="'cp_st_'+connector.id">&nbsp;&nbsp;&nbsp;&nbsp;</span>
 ...
 --%>
                        ...
                        <div class="subitem_content">
                            <div class="subitem_li" v-for="connection in connector.connections"
                                 v-bind:id="'conn_' + connection.id"
                                 v-bind:cp_id="connector.id" v-bind:cp_tp="connector.tp" v-bind:conn_id="connection.id"
                                 v-bind:tt="connection.title +' '+connection.name">
                                <table style="width:100%;">
                                    <tr>
                                        <td width0="10px">
                                            <span v-bind:id="'conn_st_'+connection.id"><i
                                                    class="fa fa-chain-broken "></i></span>
                                        </td>
                                        <td width="90%">
                                            {{connection.title}} [{{connection.name}}]
                                        </td>
                                        <td width0="10px" v-bind:cp_id="connector.id" v-bind:cpt_id="+connection.id"
                                            v-bind:id="'cpt_msgs_'+connection.id" style="white-space:nowrap;">
                                        </td>
            ...
            <div id="conn_ch"
                 style="width:25%;height:100%;overflow:hidden;float:left;border-top: solid 1px;border-color: #cccccc;"></div>
    ...
    <div id="div_brw" class="hj-transverse-split-div subwin" style="width:15%">
            ...
            <div class="btn-group open" id="btn_menu_tree">
                ...
                <%--
				  <a class="btn "  href="#">
				   ...
				   --%>
                &nbsp;&nbsp;<span title="<wbt:g>refresh,browser,tree</wbt:g>"><i onclick="refresh_ui()"
        ...
        <div class="subwin_content" style="overflow:auto">
            <div id="tree" class="tree"
                 style="width:100%;overflow:auto;left:-30px;position:absolute;height:700px"></div>
            <div style="width:80%;overflow: hidden;height:100px">&nbsp;</div>
        </div>
        <label class="hj-transverse-split-label"></label>
    </div>

    <div id="div_content" class="hj-transverse-split-div"
         style="width:70%;background-color: #ebeef3;border:1px solid;border-color: #ebeef3">
        <div style="padding-left:10px;padding-right:0px;marign0:10px;width:100%;height:100%;position:inherit;background-color: #ebeef3;z-index:60000"
             id="right_tabs">

            <div class="layui-tab layui-tab-brief" lay-filter="tab_hmi_editor" lay-allowclose="true"
                 style="width:100%;height:100%">
                <span id="right_tabs_btn" style="position:absolute;right:10px;top:10px;z-index:60001"><i
                        class="fa fa-window-restore fa-lg" aria-hidden="true"></i></span>
                ...
                <div class="layui-tab-content" style="position:relative;bottom:0px;height:100%">
                    <div class="layui-tab-item layui-show"
                         style="position:relative;top:0px;bottom:0px;width:99%;height:99%">
                        <iframe id="if_tags" src="./ua_cxt/cxt_tags.jsp?tabid=main&path=<%=path %>"
                    ...
                    <div class="layui-tab-item" style="position:relative;top:0px;bottom:0px;width:100%;height:100%">
                        <iframe id="if_prop" src="./ua/ui_prop.jsp?dlg=false&&tabid=drv&path=<%=path %>"
                                style="width:100%;height:100%;border:0px"></iframe>
                    </div>
                </div>
            </div>
...
//	{content:'sm_divider'},
        ...
        {
            content: 'Tcp <wbt:g>client</wbt:g>', callback: function () {
                edit_cpt("tcp_client", "", "");
            }
        },
        {
            content: '<wbt:g>com_p</wbt:g>', callback: function () {
                edit_cpt("com", "", "");
            }
        },
        {
            content: 'Tcp <wbt:g>server_e</wbt:g>', callback: function () {
                edit_cp("tcp_server", "");
            }
        },
...
%>
        {
            content: 'OPC DA <wbt:g>client</wbt:g>', callback: function () {
                edit_cpt("opc_da", "", "");
            }
        },
        <%
...
%>
        {
            content: 'OPC UA <wbt:g>client</wbt:g>', callback: function () {
                edit_cpt("opc_ua", "", "");
            }
        },
//	{content:'OPC Agent',callback : function(){edit_cpt("opc_agent","","");}},
        ...
        {content: 'sm_divider'},
        {
            content: '<wbt:g>virtual_e</wbt:g>', callback: function () {
                edit_cpt("virtual", "", "");
            }
        }
    ];
    ...
    var tree_menu = [
        ...
        {
            content: '<wbt:g>share_as_n</wbt:g>', callback: function () {
                share_as_node();
            }
        },
        {content: 'sm_divider'},
    ...
    $("#right_tabs_btn").click(function () {
        if ("fixed" == $("#right_tabs").css("position")) {//position:
	...
	*/
            ...
            if (3 == e.which) {
                ...
                $(this).selectMenu({
                    ...
                    data: () => {
                        ...
                        d.push({
                            content: '<i class="fa fa-link"></i> <wbt:g>add,conn</wbt:g>', callback: () => {
                                edit_cpt(cptp, cpid, "");
                            }
                        });

                        d.push({
                            content: '<i class="fa fa-pencil"></i> <wbt:g>edit,connector</wbt:g>', callback: () => {
                                edit_cp(cptp, cpid);
                            }
                        });

                        d.push({
                            content: '<i class="fa fa-file"></i> <wbt:g>imp</wbt:g> Xml <wbt:g>connector</wbt:g>',
                            callback: () => {
                        ...
                        d.push({content: 'sm_divider'});
                        d.push({
                            content: '<i class="fa fa-arrow-rotate-right"></i> <wbt:g>reset</wbt:g>', callback: () => {
                                reset_cp(cptp, cpid);
                            }
                        });
                        ...
                        if (cptp == 'tcp_server') {
                            d.push({content: 'sm_divider'});
                            d.push({
                                content: '<i class="fa fa-magic"></i> <wbt:g>config,wizard</wbt:g>', callback: () => {
                        ...
                        d.push({content: 'sm_divider'});
                        d.push({
                            content: '<i class="fa fa-times"></i> <wbt:g>del,connector</wbt:g>', callback: () => {
                                del_cp(cpid);
                            }
                        });
                        return d;
                ...
                $(this).selectMenu({
                    ...
                    data: () => {
                        ...
                        if (cptp == "opc_ua" || cptp == "opc_agent" || cptp == "opc_da") {
                            d.push({
                                content: '<i class="fa fa-pencil"></i> <wbt:g>bind</wbt:g>', callback: () => {
                        ...
                        if (cptp == "mqtt") {
                            d.push({
                                content: '<i class="fa fa-pencil"></i> <wbt:g>test</wbt:g>', callback: () => {
                        ...
                        if (cptp == "iottree_node") {
                            d.push({
                                content: '<i class="fa fa fa-history"></i> <wbt:g>sync,tree</wbt:g>', callback: () => {
                                    iottree_node_syn_tree(cptp, cpid, connid);
                                }
                            });
                        }
                        d.push({
                            content: '<i class="fa fa-eye"></i> <wbt:g>sync,monitor</wbt:g>', callback: () => {
                                window.open("./conn/cpt_mon.jsp?prjid=" + repid + "&cpid=" + cpid + "&cid=" + connid);
                            }
                        });
                        d.push({content: 'sm_divider'});
                        d.push({
                            content: '<i class="fa fa-pencil"></i> <wbt:g>edit</wbt:g>', callback: () => {
                                edit_cpt(cptp, cpid, connid);
                            }
                        });
                        d.push({
                            content: '<i class="fa fa-file"></i> <wbt:g>export</wbt:g> Xml', callback: () => {
                                export_xml_cpt(cptp, cpid, connid);
                            }
                        });
                        d.push({content: 'sm_divider'});
                        d.push({
                            content: '<i class="fa fa-times"></i> <wbt:g>del</wbt:g>', callback: () => {
                                del_cpt(cpid, connid);
                            }
                        });
                        return d;
    ...
    var cxt_menu = {
        "prj": [
            ...
            {
                op_name: "new_ch",
                op_title: "<wbt:lang>new_ch</wbt:lang>",
                op_icon: "fa fa-random",
                op_action: act_rep_new_ch
            },
            {
                op_name: "new_hmi",
                op_title: "<wbt:lang>new_hmi</wbt:lang>",
                op_icon: "fa fa-puzzle-piece",
                op_action: act_new_hmi
            },
            //{op_name:"new_tag_exp",op_title:"<wbt:lang>new_tag_mid</wbt:lang>",op_icon:"fa fa-compass",op_action:""},

            {
                op_name: "edit_prj",
                op_title: "<wbt:g>edit,prj</wbt:g>",
                op_icon: "fa fa-pencil",
                op_action: act_edit_prj
            },
            {
                op_name: "paste_ch",
                op_title: "<wbt:g>paste</wbt:g>",
                op_icon: "fa fa-clipboard",
                op_action: act_node_paste,
                op_chk: (tn) => {
            ...
            {
                op_name: "open_cxt",
                op_title: "<wbt:lang>cxt_script_test</wbt:lang>",
                op_icon: "fa fa-list-alt",
                op_action: act_open_cxt_script
            },

            {
                op_name: "access_ui",
                op_title: "<wbt:lang>access</wbt:lang>",
                op_icon: "fa fa-paper-plane",
                op_action: act_access
            },
            {
                op_name: "prop",
                op_title: "<wbt:lang>properties</wbt:lang>",
                op_icon: "fa fa-newspaper-o",
                op_action: act_prop,
                default: true
            },
            {
                op_name: "start_stop",
                op_title: "<wbt:lang>start/stop</wbt:lang>",
                op_icon: "fa fa-refresh",
                op_action: ""
            },
        ],
        "ch": [
            {
                op_name: "paste_dev",
                op_title: "<wbt:g>paste,dev</wbt:g>",
                op_icon: "fa fa-clipboard",
                op_action: act_node_paste,
                op_chk: (tn) => {
            ...
            {
                op_name: "sel_drv",
                op_title: "<wbt:lang>select_drv</wbt:lang>",
                op_icon: "fa fa-tasks",
                op_action: act_ch_sel_drv
            },


            {
                op_name: "new_tagg",
                op_title: "<wbt:lang>new_tag_group</wbt:lang>",
                op_icon: "fa fa-tags",
                op_action: act_new_tagg,
                op_chk: (tn) => {
            ...
            {
                op_name: "new_dev",
                op_title: "<wbt:lang>new_dev</wbt:lang>",
                op_icon: "fa fa-plus",
                op_action: act_ch_new_dev
            },
            {
                op_name: "find_up_dev",
                op_title: "<wbt:lang>find_up_dev</wbt:lang>",
                op_icon: "fa-solid fa-magnifying-glass",
                op_action: act_ch_find_dev
            },
            {
                op_name: "edit_ch",
                op_title: "<wbt:lang>edit_ch</wbt:lang>",
                op_icon: "fa fa-pencil",
                op_action: act_edit_ch
            },
            ...
            {
                op_name: "ch_start",
                op_title: "<wbt:lang>start</wbt:lang>",
                op_icon: "fa fa-play",
                op_action: act_ch_start_stop,
                op_chk: (tn) => {
                    return !tn.run;
                }
            },
            {
                op_name: "ch_stop",
                op_title: "<wbt:lang>stop</wbt:lang>",
                op_icon: "fa fa-times",
                op_action: act_ch_start_stop,
                op_chk: (tn) => {
                    return tn.run;
        ...
        "dev": [
            ...
            {
                op_name: "edit_dev",
                op_title: "<wbt:lang>edit_dev</wbt:lang>",
                op_icon: "fa fa-tasks",
                op_action: act_edit_dev
            },
            //{op_name:"refresh_dev",op_title:"<wbt:lang>refresh_dev</wbt:lang>",op_icon:"fa fa-tasks",op_action:act_refresh_dev},
            {
                op_name: "del_dev",
                op_title: "<wbt:lang>delete</wbt:lang>",
                op_icon: "fa fa-times",
                op_action: act_del_dev
            },
            {
                op_name: "paste_dev",
                op_title: "<wbt:lang>paste</wbt:lang>",
                op_icon: "fa fa-clipboard",
                op_action: act_node_paste
            },
            ...
            {
                op_name: "add_to_lib",
                op_title: "<wbt:g>add,to,lib</wbt:g>",
                op_icon: "fa fa-copy",
                op_action: act_node_add_to_lib
            },
            {
                op_name: "new_tagg",
                op_title: "<wbt:lang>new_tag_group</wbt:lang>",
        ...
        "tagg": [
            ...
            {
                op_name: "modify_tagg",
                op_title: "<wbt:lang>modify</wbt:lang>",
                op_icon: "fa fa-puzzle-piece",
                op_action: act_edit_tagg,
                op_chk: (tn) => {
        ...
        "hmi": [
            {
                op_name: "edit_ui",
                op_title: "<wbt:lang>edit_ui</wbt:lang>",
                op_icon: "fa fa-puzzle-piece",
                op_action: act_hmi_edit_ui,
                op_chk: (tn) => {
                    return !tn.ref;
                }
            },
            ...
            {
                op_name: "set_main_ui",
                op_title: "<wbt:lang>set_as_main_ui</wbt:lang>",
                op_icon: "fa fa-star",
                op_action: act_main_hmi,
                op_chk: (tn) => {
                    return !tn.ref;
                }
            },
    ...
    function edit_cp(cptp, cpid) {
        dlg.open_win("conn/cp_edit_" + cptp + ".jsp?prjid=" + repid + "&cpid=" + cpid,
            ...
            ['<wbt:g>ok</wbt:g>', {
                title: '<wbt:g>apply</wbt:g>',
                style: "warm",
                enable: false
            }, {title: '<wbt:g>cancel</wbt:g>', style: "primary"}, {title: '<wbt:g>help</wbt:g>', style: "primary"}],
            [
                function (dlgw) {
        ...
        dlg.open(u,
            ...
            [
                function (dlgw) {
                    ...
                    send_ajax('./conn/cpt_bind_ajax.jsp', {
                            op: "set_binds",
                            bindids: '',
                            mapstr: mapstr,
                            prjid: repid,
