            ...
            <td width="90%">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 300px;">
                        <input type="text" id="title" name="title" lay-verify="required" size="0" autocomplete="off"
                               class="layui-input">
                    </div>
                    ...
                    <div class="layui-input-inline" style="width: 100px;">
                        <select id="vt" name="vt" class="layui-input" lay-filter="vt">
                            ...
                            %>
                            <option value="<%=vt.getInt()%>" b_num="<%=bnum%>"><%=vt.getStr() %>
                            </option>
                            <%
                                }
                            %>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:180px;">
                        <select id="indicator" name="indicator" class="layui-input" lay-filter="indicator">
                            ...
                            %>
                            <option value="<%=vi.name()%>" units="<%=vusstr%>"><%=vi.getTitle() %>
                            </option>
                            <%
                                }
                            %>
...
%>
                ...
                <div class="layui-form-item" id="fi_local">
                    ...
                    <div class="layui-input-inline" style="width: 100px;" title="<wbt:g>local_ptt</wbt:g>">
                        <input type="checkbox" id="local" name="local" <%=loc_chked%> lay-skin="switch"
                               lay-filter="local" class="layui-input">
                    </div>
                    <div id="local_setting" style="<%=loc_set%>">
                        <label class="layui-form-mid"><wbt:g>default_val</wbt:g></label>
                        <div class="layui-input-inline">
                            <input type="text" id="local_defval" name="local_defval" class="layui-input"
                                   style="width: 150px;">
                        </div>
                        <div class="layui-form-mid"><wbt:g>auto_save</wbt:g></div>
                        <div class="layui-input-inline" style="width: 80px;">
                            <input type="checkbox" id="local_autosave" name="local_autosave" <%=loc_autosave_chk%>
                                   lay-skin="switch" lay-filter="local_autosave" class="layui-input">
                        </div>
                    </div>
                </div>
                <%
                ...
                <div class="layui-form-item" id="addr_setting">
                    <label class="layui-form-label"><wbt:g><%=(bmid ? "js_exp" : "addr") %>
                    </wbt:g>:</label>
                    <div class="layui-input-inline" style="width:400px">
                        <%
                            if (bmid) {
                        %><textarea style="width:100%;height:100px;overflow:auto;white-space: nowrap;font-size: 12px"
                                    id="addr" name="addr" class="layui-input" ondblclick="on_js_edit()"
                                    title="<wbt:g>dbclk_open_jse</wbt:g>"></textarea>
                        <%
                        } else {
                        %>
                    ...
                    <div class="layui-input-inline">
                        <%
                            if (!bmid) {
                        %>
                        <button class="layui-btn layui-btn-primary" title="Check Address" onclick="chk_addr()"><i
                                class="fa-solid fa-check"></i></button>
                        <button class="layui-btn layui-btn-primary" title="Address Help" onclick="help_addr()"><i
                ...
                <div class="layui-form-item" id="w_js_setting">
                    ...
                    <div class="layui-input-inline" style="width:800px;color:#c1c1c1;font-size: 12px;">
                        ($tag,$input)=>{
                        <textarea style="width:100%;height:100px;overflow:auto;white-space: nowrap;" id="mid_w_js"
                                  name="mid_w_js" class="layui-input" ondblclick="on_wjs_edit()"
                                  title="<wbt:g>dbclk_open_jse</wbt:g>"></textarea>
                        }
                    </div>
                    <div class="layui-input-inline">
                ...
                <div class="layui-form-item" id="transfer_setting">
                    ...
                    <div class="layui-input-block" style="width:370px">
                        <input id="transfer_s" name="transfer_s" class="layui-input" readonly="readonly"
                               onclick="edit_trans()"/>
                    </div>
                </div>
                ...
                <div class="layui-form-item" id="val_filter_setting">
                    ...
                    <div class="layui-input-block" style="width:370px">
                        <input type="checkbox" id="b_val_filter" name="b_val_filter" <%=b_val_filter_chked%>
                               lay-skin="switch" lay-filter="b_val_filter" class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:50px;">
                        <button class="layui-btn layui-btn-primary" title="Add Alert Source" onclick="edit_alert()"><i
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="desc" name="desc" lay-verify="required" placeholder="" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
            </td>
            <td>
                <div class="layui-btn-container">
                    <button onclick="on_new_tag()" class="layui-btn layui-btn-primary" style="width:90px;">
                        <wbt:g>add</wbt:g></button>
                    <button onclick="on_copy_tag()" class="layui-btn layui-btn-primary" style="width:90px;">
                        <wbt:g>copy</wbt:g></button>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: id, name: n, title: tt, desc: desc, mid: bmid,
