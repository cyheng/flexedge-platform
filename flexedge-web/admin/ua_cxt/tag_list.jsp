...
<form class="layui-form" action="">
    ...
    <blockquote class="layui-elem-quote ">&nbsp;
        <div style="left:20px;top:5px;position:absolute;font:bold;font-size: 18"><%=node_tags.getNodePath() %>
        </div>
        ...
        <div style="float: right;margin-right:10px;font: 15px solid;color:#fff5e2">
            ...
            %>
            <button type="button" class="layui-btn layui-btn-sm layui-border-blue" onclick="add_or_modify_tag('')">+Add
                Tag
            </button>&nbsp;&nbsp;
            <%
                }
            ...
            <input type="checkbox" id="show_sys" name="show_sys" lay-filter="show_sys" lay-skin="switch"
                   lay-text="Hide System Tags|Show System Tags"/>
        </div>
    </blockquote>
        ...
        <table class="oc_div_list" style="margin-top:10px" id="tb_cur">
            ...
            >
                <td style="text-align: center;">
                    ...
                    %></td>
                <td style="text-align: center;"><%=(tag.isMidExpress() ? "✔" : "") %>
                </td>
                ...
                <td>
                    <%
                        if (tag.isCanWrite()) {
                    %>
                    <input type="text" id="ctag_w_<%=tag.getId()%>" value="" size="8"/><a
                        href="javascript:w_tag('<%=tag.getId()%>')"><i class="fa fa-pencil-square"
                ...
                <td>
                    ...
                    %>
                    <a href="javascript:del_tag('<%=tag.getId()%>')"><i class="fa fa-times" aria-hidden="true"></i></a>&nbsp;&nbsp;
                    <a href="javascript:add_or_modify_tag('<%=tag.getId()%>')"><i class="fa fa-pencil "
                                                                                  aria-hidden="true"></i></a>
                    <%
                        }
                    %>&nbsp;
...
<table width='100%' border='1' height="120">
    <tr>
        <td>
            script test <input type='button' value='run' onclick="run_script_test('')"/> <input type='button'
                                                                                                value='ttt'
                                                                                                onclick="run_script_test1()"/>
        </td>
...
<script>
                ...
                $(this).selectMenu({
                    ...
                    data: () => {
                        ...
                        if (get_selected_tagids() != '')
                            d.push({
                                content: 'Copy Selected Tag', callback: () => {
    ...
    function del_tag(id) {
        ...
        ret.id = id;
        dlg.confirm("make sure to delete selected tags？", {
            btn: ["Yes", "Cancel"],
