                ...
                <table style="width:100%;height:100%;">
                    <tr height="75%">
                        <td colspan="2" style="vertical-align: top;">
                            ...
                            <div id='script_test'
                                 style="overflow: scroll;width:100%;height:<%=cheight%>;padding:5px;"></div>
                        ...
                        <td colspan="2">
                            <div style="position: relative;height:20px;">
                                ...
                                <%
                                    if (Convert.isNotNullEmpty(path)) {
                                %>
                                <div style="right:10px;top:0px;position:absolute;"><input type='button'
                                                                                          value='<wbt:g>test_run</wbt:g>'
...
<script>
    ...
    function on_tree_node_sel(n) {
        ...
        var id = n.id;
        send_ajax("cxt_script_help_ajax.jsp", {
            op: "sub_detail",
            path: path,
            id: id,
            pm_objs: pm_objs
