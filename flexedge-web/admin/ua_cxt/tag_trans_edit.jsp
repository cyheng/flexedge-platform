...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="name" value="none" title="<wbt:g>none</wbt:g>" checked="checked"
                   lay-filter="name">
            <%
                for (ValTranser vt : ValTranser.listValTransers()) {
            %> <input lay-filter="name" type="radio" name="name" value="<%=vt.getName() %>" title="<%=vt.getTitle() %>"
                      onchange="show_card()"/><%
            }
        %>
        </div>
    ...
    <div class="layui-form-item" style="display:none" id="dt_tp">
        ...
        <div class="layui-input-inline" style="width: 120px;">
            <select id="_vt" name="_vt" class="layui-input" placeholder="">
                ...
                %>
                <option value="<%=vt.getInt()%>" <%=sel %>><%=vt.getStr() %>
                </option>
                <%
                    }
                %>
    ...
    <div class="layui-card" id="card_js" style="display:none">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ($tag,$input)=>{
                <textarea rows="9" cols="60" id="js_txt" style="border-color: #e6e6e6" ondblclick="on_js_edit()"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ($tag,$input)=>{
                <textarea rows="9" cols="60" id="inverse_js_txt" style="border-color: #e6e6e6"
                          ondblclick="on_js_edit_inv()" title="double click to open edit JS dialog"></textarea>
                <br>}
            </div>
        </div>
        <!--
