...
%><%
    ...
    UANode pnode = null;
    UAHmi hmi = null;
    if (Convert.isNotNullEmpty(hmipath)) {//edit
        bedit = true;
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="name" name="name" lay-verify="required" value="<%=name %>" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="title" name="title" lay-verify="required" value="<%=title %>" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: id, name: n, title: tt, desc: desc
        });
