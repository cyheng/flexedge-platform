...
<%@ page import="
	cn.doraro.flexedge.core.*,
                 ...
                 cn.doraro.flexedge.driver.common.*,
                 java.io.*,
                 java.util.*,
                 java.net.*,
                 java.util.*" %>
...
<form class="layui-form" action="" onsubmit="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            &nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="4" cols="80" id="on_init_js" style="left:10px;border-color: #e6e6e6"
                                              ondblclick="on_init_js_edit()"
                                              title="double click to open edit JS dialog"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" cols="80" id="on_msgin_js"
                                              style="left:10px;border-color: #e6e6e6" ondblclick="on_msgin_js_edit()"
                                              title="double click to open edit JS dialog"></textarea>
            <br>&nbsp;&nbsp;&nbsp;&nbsp;}
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" cols="80" id="on_tagw_js" style="left:10px;border-color: #e6e6e6"
                                              ondblclick="on_tagw_js_edit()"
                                              title="double click to open edit JS dialog"></textarea>
            <br>&nbsp;&nbsp;&nbsp;&nbsp;}
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ($ch,$connpt)=>{<br>
            &nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" cols="80" id="on_loop_js" style="left:10px;border-color: #e6e6e6"
                                              ondblclick="on_loop_js_edit()"
                                              title="double click to open edit JS dialog"></textarea>
            <br>&nbsp;&nbsp;&nbsp;&nbsp;}
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function get_conf_obj() {
        ...
        return {
            on_init_js: on_init_js, on_msgin_js: on_msgin_js, msg_in_str: msg_in_str,
    ...
    function on_init_js_edit() {
        ...
        dlg.open("../../ua_cxt/cxt_script.jsp?dlg=true&no_parent=false&no_this=false&path=" + ch_path,
            {
                title: "<wbt:g>edit</wbt:g> JS -  On Init (run once)",
                w: '600px',
                h: '400px',
                js_txt: txt,
                pm_objs: {$connpt: connpt_cn}
            },
    ...
    function on_msgin_js_edit() {
        ...
        dlg.open("../../ua_cxt/cxt_script.jsp?dlg=true&no_parent=false&no_this=false&path=" + ch_path,
            {
                title: "<wbt:g>edit</wbt:g> JS -  On MsgIn",
                w: '600px',
                h: '400px',
                js_txt: txt,
                pm_objs: {$connpt: connpt_cn}
    ...
    function on_tagw_js_edit() {
        ...
        dlg.open("../../ua_cxt/cxt_script.jsp?dlg=true&no_parent=false&no_this=false&path=" + ch_path,
            {
                title: "<wbt:g>edit</wbt:g> JS - On Tag Write",
                w: '600px',
                h: '400px',
                js_txt: txt,
                pm_objs: {$connpt: connpt_cn}
