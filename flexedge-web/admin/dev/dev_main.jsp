...
<table style="width:100%;height:<%=tbh %>;border:0px;">
    <tr>
        <td style="width:45%;height:100%">
            <iframe name="dev_left" src="dev_left.jsp?edit=<%=bedit %>&libid=<%=libid %>&catid=<%=sel_catid %>"
                    style="width:100%;height:100%;border:0"></iframe>
        </td>
        <td style="width:55%;height:100%">
            <iframe name="dev_right" src="" style="width:100%;height:100%;border:0"></iframe>
        </td>
    </tr>
</table>
<%
...
<table style="width:100%;height:<%=tbh %>;border:0px;">
    <tr>
        <td style="width:100%;height:100%">
            <iframe name="dev_left" src="dev_left.jsp?edit=<%=bedit %>&libid=<%=libid %>"
                    style="width:100%;height:100%;border:0"></iframe>
        </td>
    </tr>
</table>
