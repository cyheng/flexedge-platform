...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="devdef_title" name="devdef_title" value="<%=title %>" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="libcat_title" id="libcat_title" value="" onclick="select_libcat()"
                   class="layui-input"/>
    ...
    function do_submit(cb) {
        ...
        $.ajax(pm).done((ret) => {
            if (typeof (ret) == 'string') {
                if (ret == "ok") {
                    dlg.confirm('device with name = ' + n + ' already exists, do you want to overwrite it?', {
                        btn: ["Yes", "Cancel"],
