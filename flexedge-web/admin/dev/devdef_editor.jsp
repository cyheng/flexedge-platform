...
<head>
    ...
    <style>
        ...
        #tree .icon_dev {
            background: url('../inc/sm_icon_dev.png') 0 0 no-repeat;
            width: 24px;
            height: 24px;
        }

        #tree .icon_ch {
            background: url('../inc/sm_icon_ch.png') 0 0 no-repeat;
            width: 24px;
            height: 24px;
        }

        #tree .icon_tagg {
            background: url('../inc/sm_icon_tagg.png') 0 0 no-repeat;
            width: 24px;
            height: 24px;
        }
...
<div class='hj-wrap'>
    ...
    <div class="hj-transverse-split-div" style="width:80%;background-color: #ebeef3">
        <div style="padding-left:10px;padding-right:0px;marign0:10px;height:100%;width:100%;position:inherit;background-color: #ebeef3;z-index:60000"
             id="right_tabs">
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="tab_hmi_editor" lay-allowclose="true"
                ...
                <div class="layui-tab-content" style="position:relative;bottom:0px;height:100%">
                    <div class="layui-tab-item layui-show"
                         style="position:relative;top:0px;bottom:0px;width:100%;height:100%">
...
<script>
    ...
    var cxt_menu = {
        ...
        "tagg": [
            {
                op_name: "new_tag",
                op_title: "<wbt:lang>new_tag</wbt:lang>",
                op_icon: "fa fa-tag",
                op_action: act_node_new_tag
            },
            {
                op_name: "new_hmi",
                op_title: "<wbt:lang>new_hmi</wbt:lang>",
