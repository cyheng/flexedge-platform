...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="binded_id" name="binded_id" readonly="readonly" lay-verify="required"
    ...
    <div class="layui-form-item" id="divtag">
        ...
        <div class="layui-input-inline">
            <input type="text" id="tag" name="tag" required lay-verify="required" autocomplete="off" class="layui-input"
                   onclick="sel_tag()">
        </div>
    </div>
    <div class="layui-form-item" id="divtjs" style="display:none;">
        ...
        <div class="layui-input-block">
            ()=>{
            <textarea id="js" name="js" placeholder="" class="layui-textarea" rows="10"
                      ondblclick="on_client_js_edit()"></textarea>
            }
            <br/>
