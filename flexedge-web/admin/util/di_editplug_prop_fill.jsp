...
<div style="float:left; display:block;width:100%;border0:1px solid">
    <div style="float:left;width:19%">
        ...
        <div class="layui-form-item">
            ...
            <div style="">
                <div id="fcolor_0" class="citem" onclick="sel_color(0)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        onclick="sel_color_txt(0)"><i class="fa fa-pencil"></i></a></div>
                <div id="fcolor_1" class="citem" onclick="sel_color(1)" style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        onclick="sel_color_txt(1)"><i class="fa fa-pencil"></i></a></div>
                <div id="fcolor_2" class="citem" onclick="sel_color(2)" style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        onclick="sel_color_txt(2)"><i class="fa fa-pencil"></i></a></div>
                <div id="fcolor_3" class="citem" onclick="sel_color(3)" style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                        onclick="sel_color_txt(3)"><i class="fa fa-pencil"></i></a></div>
            </div>
        </div>
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item contitem">
                    ...
                    <div style="white-space: nowrap;width:300px">
                        ...
                        <div id="rotation_sld" style="float:left;margin:10px;width:200px"></div>
                        <input type="text" size="10" id="rotation" value="0" readonly="readonly"
...
<div style="float:left;position:relative;text-align:center; width:230px;height:130px;white-space: nowrap;margin-left:50px">
    Preview:
    <div id="div_preview" style="width:120px;border:1px solid;height:120px;margin-left:50px">
