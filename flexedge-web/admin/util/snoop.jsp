...
<%@page import="java.io.PrintStream,java.util.* , java.io.* , java.net.*,cn.doraro.flexedge.core.* " %>
<%
...
%>
&nbsp;&nbsp;&nbsp;<%=tmpf.getAbsolutePath() %> len=<%=tmpf.length() / 1024 %>K <a target="_blank"
                                                                                  href="snoop_download.jsp?f=<%=tmpf.getAbsolutePath() %>&ln=1024">download</a><br/>
<%
                }
            }
    }
