...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 50px;">
            <input type="checkbox" id="b_inner_record" name="b_inner_record" <%=b_inner_record_chked%> lay-skin="switch"
                   lay-filter="b_inner_record" class="layui-input">
        </div>
        <div class="layui-form-mid">Keep Days:</div>
        <div class="layui-input-inline" style="width:80px;">
            <input type="text" name="inner_record_days" id="inner_record_days" value="<%=inner_record_days %>"
                   class="layui-input"/>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 50px;">
            <input type="checkbox" id="b_outer_record" name="b_outer_record" <%=b_outer_record_chked%> lay-skin="switch"
                   lay-filter="b_outer_record" class="layui-input">
        </div>
        <div class="layui-form-mid">Source:</div>
        <div class="layui-input-inline" style="width:120px;">
            <select id="outer_record_sor" name="outer_record_sor" class="layui-input" placeholder=""
                    lay-filter="outer_record_sor">
                <option value="">---</option>
                <%
                ...
                %>
                <option value="<%=n%>"><%=sor.getSorTpTitle() %>-<%=sor.getTitle() %>
                </option>
                <%
                    }
                %>
        ...
        <div class="layui-form-mid">Keep Days:</div>
        <div class="layui-input-inline" style="width:80px;">
            <input type="text" name="outer_record_days" id="outer_record_days" value="<%=outer_record_days %>"
                   class="layui-input"/>
        </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: id,
            n: n,
            trigger_en: b_trigger_en,
            release_en: b_release_en,
            t: tt,
            en: ben,
            trigger_c: trigger_c,
            release_c: release_c,
            lvl: lvl
            ,
            b_inner_record: b_inner_record,
            inner_record_days: inner_record_days,
            b_outer_record: b_outer_record,
            outer_record_days: outer_record_days,
            outer_record_sor: outer_record_sor
        });
