...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="name" name="name" required lay-verify="required" placeholder="Pls input name"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="text-align: left;color:green;width:400px;">
            ...
            <textarea id="clientjs" name="clientjs" placeholder="" class="layui-textarea" rows="6"
                      ondblclick="on_client_js_edit()" title="double click to open js editor"></textarea>
            }
        </div>
        <div class="layui-form-mid" style="padding: 0!important;top:15px;">
            <button type="button" class="layui-btn layui-btn-primary" onclick="on_client_js_edit()"
                    title="open js editor">...
            </button>
        </div>
    </div>
    <%
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="text-align: left;color:green;width:400px;">
            ($input)=&gt;{
            <textarea id="serverjs" name="serverjs" placeholder="" class="layui-textarea" rows="6"
                      ondblclick="on_js_edit()" title="double click to open js editor"></textarea>
        ...
        <div class="layui-form-mid" style="padding: 0!important;top:15px;">
            <button type="button" class="layui-btn layui-btn-primary" onclick="on_js_edit()" title="open js editor">
                ...
            </button>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function insertAtCursor(txtarea_id, txt) {
        ...
        if (document.selection) {//IE support
            ...
            sel.text = txt;
            sel.select();
        } else if (txtarea.selectionStart || txtarea.selectionStart == '0') {//MOZILLA/NETSCAPE support
