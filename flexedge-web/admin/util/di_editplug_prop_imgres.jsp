...
<table class="prop_table">
    <tr>
        <td colspan="2">
            <div id="prop_edit_path" class="prop_edit_path">Resources : <%=nodetitle %>
            </div>
        </td>
    </tr>
    <tr>
...
<script type="text/javascript">
    ...
    function del_res() {
        ...
        dlg.confirm('delete this resourse item [' + cur_resitem.name + ']?', {
            btn: ["Yes", "Cancel"],
    ...
    function add_file_onchg() {
        ...
        fd.append("file", f);
        $.ajax({
            "url": "rescxt_item_fileup.jsp", type: "post", "processData": false, "contentType": false,
            "data": fd,
