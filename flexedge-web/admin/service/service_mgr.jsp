...
<table class="layui-table">
    ...
    <tr>
        ...
        <td><span id="" style="width:20px;height:20px;background-color: <%=run_c %>;">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;<wbt:g><%=run_t %>
        </wbt:g></td>
        <td>
            <%
                if (as.isEnable()) {
            ...
            <i id="prj_btn_stop" class="fa fa-pause fa-lg" style="color:red" title="stop service"
               onclick="start_stop(false,'<%=as.getName()%>')"></i>

            <%
            } else {
            %>
            <i id="prj_btn_start" class="fa fa-play fa-lg" style="color:green" title="start service"
               onclick="start_stop(true,'<%=as.getName()%>')"></i>
            <%
                    }
                }
            %>

            <a href="javascript:edit_server('<%=as.getName()%>','<%=as.getTitle()%>')"><i
