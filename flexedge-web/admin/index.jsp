...
<div class="iot-top-menu-wrap">
    <div class="container">
        <!-- start logo -->
        <div class="iot-logo">
            <a><img src="inc/logo1.png" width="40px" height="40px"/> IOT-Tree <%=sname %>
            </a>
        </div>
        <div class="top_lan">
            ...
            <nav role="navigation" class="collapse navbar-collapse bs-navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="https://github.com/bambooww/iot-tree.git" target="_blank" class=""><i
                            class="icon icon-home"></i><wbt:lang>home</wbt:lang></a></li>
                    <li><a href="/doc" target="_blank"><i class="icon icon-topic"></i><wbt:lang>helper</wbt:lang></a>
                    </li>
                    <li><a href="mailto:iottree@hotmail.com"><i
                            class="icon icon-topic"></i><wbt:lang>feedback</wbt:lang></a></li>
                </ul>
            </nav>
        </div>
        <!-- end nav-->
        ...
        <div class="iot-user-nav" style="right:70px;position: absolute;">
            <div class="iot-top-user" style="right:150px;">
                ...
                %>
                <button class="layui-btn layui-btn-primary layui-btn-xs" class0="list" id="SysSetting"
                    ...
                    <div class="iot-mod iot-question-detail iot-item">
                        <div class="mod-head">
                            ...
                            <div style="float:left;top:5px;position: absolute;left:160px">
                                <a class0="btn btn-success" style0="width:80px;height:40px;align-content: center;"
                                   href="javascript:add_prj()">
							...
							<span class="fa-stack">
							  ...
							  <i class="fa fa fa-plus fa-stack-1x fa-inverse"></i>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a class0="btn btn-success" style0="width:100px;height:40px;"
                                   href="javascript:imp_prj()">
							<span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa-arrow-down fa-stack-1x fa-inverse"></i>
							</span>&nbsp;<wbt:lang>import</wbt:lang>
                                    <input type="file" id='add_file' onchange="add_file_onchg()" name="file"
                                           style="left:-9999px;position:absolute;" accept=".zip"/>
                                </a>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a class0="btn btn-success" style0="width:100px;height:40px;"
                                   href="javascript:imp_prj_demo()">
							<span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa-arrow-down fa-stack-1x fa-inverse"></i>
                        ...
                        <div class="mod-body">
                            <div class="content markitup-box" style="height:200px:overflow:auto">
                                ...
                                <div class="aw-item btn_sh_c" id="<%=tmpid%>" style="<%=cssstr%>">
                                    ...
                                    <a class="text title" href="javascript:open_rep('<%=rep.getId()%>')" data-id="8"
                                       title="<%=rep.getName() %>"><%=rep.getTitle() %>
                                    </a>
...
<span class="fa-stack">
          ...
          %>
           <a class0="btn btn-success download-btn white" href="javascript:open_rep('<%=rep.getId()%>')"
              title="show detail">
           ...
           <a class0="btn btn-success " style="color: #e33a3e" href="javascript:del_rep('<%=rep.getId()%>')"
              title="delete">
              <span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-times fa-stack-1x fa-inverse"></i>
                                        ...
                                        <div style="width:150px;border:0px solid;float: right">&nbsp;
                                            <%
                                                if (rep.isMainPrj()) {
                                            %>&nbsp;&nbsp;<span
                                                    class="layui-badge layui-bg-blue"><wbt:lang>main_prj</wbt:lang></span><%
                                                }

                                                if (rep.isAutoStart()) {
                                            %>&nbsp;&nbsp;<span
                                                    class="layui-badge layui-bg-blue"><wbt:lang>auto_start</wbt:lang></span><%
                                                }
                                            %>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-color-999">
                                        ...
                                        <span class="text-color-666"
                                              style="left:200px;position: absolute;">•<wbt:lang>modified_date</wbt:lang>:<%=Convert.toFullYMDHMS(new Date(rep.getSavedDT())) %>
           &nbsp;&nbsp;
<%
...
%><span style="color:blue;"> &lt;-&gt; <wbt:lang>remote_station</wbt:lang> [<%=pstation.getId() %>] </span><%
                                ...
                                <div style="border:0px solid #ffff00;height:45px;text-align:right;padding-right:30px;">
                                    <a id="more_prj_show" onclick="more_prj()"><wbt:lang>more_prjs</wbt:lang>...</a>
                                </div>
                                <%
                                    }
                                %>
                        ...
                        <div class="mod-head">
                            ...
                            <div style="float:left;top:5px;position: absolute;left:210px">
							  ...
							  <i class="fa fa-arrow-down fa-stack-1x fa-inverse"></i>
                                    ...
                                    <input type="file" id='devlib_add_file' onchange="devlib_add_file_onchg()"
                                           name="devlib_file" style="left:-9999px;position:absolute;" accept=".zip"/>
                                </a>
                                <%--
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                 ...
                                 --%>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a title="device library help" style="width:100px;height:40px;"
                                   href="/doc/en/quick/quick_know_devlib.md" target="_blank">
							<span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
		...
		<img src="./inc/sm_icon_dev.png"/> &nbsp;<a class="text title" href="javascript:open_devlib('<%=lib.getId()%>')"
                                                    data-id="8"><%=lib.getTitle() %></a>
		
		
		<span class="btn_sh">

           <a class0="btn btn-success download-btn white" href="javascript:devlib_add_or_edit('<%=lib.getId()%>')"
              title="show detail">
              <span class="fa-stack fa-1x">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-pencil  fa-stack-1x fa-inverse"></i>
           ...
           <a class0="btn btn-success " style="color: #e33a3e" href="javascript:devlib_del('<%=lib.getId()%>')"
              title="delete">
              <span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-times fa-stack-1x fa-inverse"></i>
                    ...
                    <div class="iot-mod iot-question-detail iot-item">
                        <div class="mod-head">
                            ...
                            <div style="float:left;top:5px;position: absolute;left:210px">
							  ...
							  <i class="fa fa-arrow-down fa-stack-1x fa-inverse"></i>
                                    ...
                                    <input type="file" id='complib_add_file' onchange="complib_add_file_onchg()"
                                           name="devlib_file" style="left:-9999px;position:absolute;" accept=".zip"/>
                                </a>
                                <%--
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                 ...
                                 --%>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a title="git help" style="width:100px;height:40px;"
                                   href="/doc/en/quick/quick_know_hmilib.md" target="_blank">
							<span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa-question fa-stack-1x fa-inverse"></i>
							</span>
                        ...
                        <div class="mod-body" id="cont_hmilib" style0="display:none">
                            ...
                            <span class="text-color-666"><%=Convert.toFullYMDHMS(new Date(lib.getCreateDT())) %></span>
                             --%>
                            <span class="lib_item btn_sh_c">
		<i class="fa-solid fa-puzzle-piece"></i> &nbsp;<a class="text title"
                                                          href="javascript:open_complib('<%=lib.getId()%>')"
                                                          data-id="8"><%=lib.getTitle() %></a>
		
		
		<span class="btn_sh">

           <a class0="btn btn-success download-btn white" href="javascript:complib_add_or_edit('<%=lib.getId()%>')"
              title="show detail">
              <span class="fa-stack fa-1x">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-pencil  fa-stack-1x fa-inverse"></i>
           ...
           <a class0="btn btn-success " style="color: #e33a3e" href="javascript:complib_del('<%=lib.getId()%>')"
              title="delete">
              <span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-times fa-stack-1x fa-inverse"></i>
                            ...
                            %>
                            <span class="lib_item" onclick="complib_add_or_edit()"><i
                    ...
                    <div class="iot-mod iot-question-detail iot-item">
                        <div class="mod-head">
                            ...
                            <div style="float:left;top:5px;position: absolute;left:210px">
                                <a class0="btn btn-success" style0="width:80px;height:40px;align-content: center;"
                                   href="javascript:add_or_edit_simins()">
							...
							<span class="fa-stack">
							  ...
							  <i class="fa fa-arrow-down fa-stack-1x fa-inverse"></i>
                                ...
                                <input type="file" id='add_sim_file' onchange="add_sim_file_onchg()" name="file"
                                       style="left:-9999px;position:absolute;" accept=".zip"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;
							...
							<span class="fa-stack">
							  ...
							  <i class="fa fa-arrow-down fa-stack-1x fa-inverse"></i>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a title="simulator help" style="width:100px;height:40px;" href="/doc/en/sim/index.md"
                                   target="_blank">
							<span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa-question fa-stack-1x fa-inverse"></i>
                            ...
                            <div style="float:right;top:5px;position: absolute;right:10px"
                                 onclick="show_hide('cont_sim')"><i class="fa fa-bars fa-lg"></i></div>
                        </div>
                        <div class="mod-body" id="cont_sim" style0="display:none">
                            <div class="content markitup-box" style="height:200px:overflow:auto">
                                ...
                                <div class="aw-item btn_sh_c" id="<%=tmpid%>">
                                    ...
                                    <a class="text title" href="javascript:open_simins('<%=ins.getId()%>')"
                                       data-id="8"><%=ins.getTitle() %>
                                    </a>
                                    <div class="inline-block pull-right text-left ">
          ...
          <span class="btn_sh">
           ...
           <a class0="btn btn-success download-btn white" href="javascript:add_or_edit_simins('<%=ins.getId()%>')"
              title="show detail">
              <span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-pencil fa-stack-1x fa-inverse"></i>
...
<span class="fa-stack">
          ...
          %>
           ...
           <a class0="btn btn-success " style="color: #e33a3e" href="javascript:del_simins('<%=ins.getId()%>')"
              title="delete">
               <span class="fa-stack">
							  <i class="fa fa-square fa-stack-1x"></i>
							  <i class="fa fa fa-times fa-stack-1x fa-inverse"></i>
                                    ...
                                    <div class="text-color-999">
                                        ...
                                        • <wbt:lang>modified_date</wbt:lang>:<span
                                            class="text-color-666"><%=Convert.toFullYMDHMS(new Date(ins.getSavedDT())) %></span>
                                    </div>
                                </div>
                                <%
                                    }
                ...
                <div class="iot-side-bar">
                    ...
                    <div class="iot-mod iot-text-align-justify">
                        <div class="mod-head">
                            ...
                            <span class="op" onclick="mgr_pstation()" style="right:50px;" title="manage remote station"><i
                                    class="fa-solid fa-satellite-dish"></i></span>
...
<script type="text/javascript">
    ...
    function del_rep(id) {
        dlg.confirm("<wbt:lang>del_sure</wbt:lang>", {
            btn: ["<wbt:lang>yes</wbt:lang>", "<wbt:lang>cancel</wbt:lang>"],
            title: "<wbt:lang>del_confirm</wbt:lang>"
        }, function () {
    ...
    function open_devlib(id) {
        ...
        dlg.open_win("dev/dev_main.jsp?edit=true&libid=" + id,
            ...
            [{title: '<wbt:lang>close</wbt:lang>', style: "primary"}, {
                title: '<wbt:lang>help</wbt:lang>',
                style: "primary"
            }],
            [
                function (dlgw) {
    ...
    function add_file_onchg() {
        ...
        fd.append("file", f);
        $.ajax({
            "url": "ua/prj_imp_upload.jsp", type: "post", "processData": false, "contentType": false,
            "data": fd,
    ...
    function devlib_add_file_onchg() {
        ...
        fd.append("file", f);
        $.ajax({
            "url": "dev/lib_imp_upload.jsp", type: "post", "processData": false, "contentType": false,
            "data": fd,
            success: function (data) {
                //dlg.msg(data);
                //location.reload();
    ...
    function devlib_del(libid) {
        dlg.confirm('<wbt:lang>del,this,dev,lib</wbt:lang>?', {
            btn: ['<wbt:lang>yes</wbt:lang>', '<wbt:lang>cancel</wbt:lang>'],
            title: "<wbt:lang>del,confirm</wbt:lang>"
        }, function () {
    ...
    function complib_add_file_onchg() {
        ...
        fd.append("file", f);
        $.ajax({
            "url": "ua_hmi/comp_lib_imp_upload.jsp", type: "post", "processData": false, "contentType": false,
            "data": fd,
            success: function (data) {
                //dlg.msg(data);
                //location.reload();
    ...
    function complib_del(libid) {
        dlg.confirm('<wbt:lang>del,this,hmi,lib</wbt:lang>?', {
            btn: ["<wbt:lang>yes</wbt:lang>", "<wbt:lang>cancel</wbt:lang>"],
            title: "<wbt:lang>del,confirm</wbt:lang>"
        }, function () {
    ...
    function del_simins(id) {
        dlg.confirm("<wbt:lang>del,this,simins</wbt:lang>?", {
            btn: ["<wbt:lang>yes</wbt:lang>", "<wbt:lang>cancel</wbt:lang>"],
            title: "<wbt:lang>del,confirm</wbt:lang>"
        }, function () {
    ...
    function add_sim_file_onchg() {
        ...
        fd.append("file", f);
        $.ajax({
            "url": "./sim/sim_upload_imp.jsp", type: "post", "processData": false, "contentType": false,
            "data": fd,
            success: function (data) {
                if (data.indexOf("succ") == 0)
                    location.reload();
    ...
    function del_sor(id) {
        ...
        dlg.confirm('<wbt:g>del,this,sor</wbt:g> [' + ob.attr('n') + '] ?', {
    ...
    function show_pstations(objs) {
        //console.log(objs);
        let tmps = "";
        for (let ob of objs) {//console.log(ob) ;
    ...
    function del_pstation(id) {
        let ob = $("#pstation_" + id);
        event.stopPropagation();
        dlg.confirm('<wbt:g>del,this,</wbt:g>' + ob.attr('t') + ' [' + ob.attr('station_id') + '] ?', {
            btn: ["<wbt:g>yes</wbt:g>", "<wbt:g>cancel</wbt:g>"],
            title: "<wbt:g>del,confirm</wbt:g>"
        }, function () {
