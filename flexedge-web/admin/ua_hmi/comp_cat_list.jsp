    ...
    <table id="top_oper">
        <tr>
            <td style="padding-left: 5px;">
                <a id="top_oper_add_dev" class="layui-btn  layui-btn-sm layui-btn-primary "><i
                        class="fa-regular fa-square-plus"></i>&nbsp;Add Device</a>
            </td>
            <td>
    ...
    <tr id="devdef_" onclick="on_clk_def('<%=ddid%>','<%=dd.getTitle() %>')">
        ...
        <td>
            ...
            <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit basic"
                    onclick="edit_devdef('<%=ddid%>')"><i class="fa fa-pencil"></i></button>

            <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit detail"
                    onclick="edit_devdef_detail('<%=ddid%>')"><i class="fa-regular fa-pen-to-square"></i></button>
