...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="text-align: left;color:green;">
            ($this)=>
            <textarea id="onGetJS" name="onGetJS" placeholder="" class="layui-textarea" rows="8"
                      ondblclick="on_client_get_js_edit()" title="double click to open js editor"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="text-align: left;color:green;">
            ($this,$value)=>
            <textarea id="onSetJS" name="onSetJS" placeholder="" class="layui-textarea" rows="10"
                      ondblclick="on_client_set_js_edit()" title="double click to open js editor"></textarea>
        </div>
    </div>
</form>
</body>
