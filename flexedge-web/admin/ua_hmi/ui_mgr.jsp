...
<div class="right">
    <div class="blk_top">
        <blockquote class="layui-elem-quote ">UI <wbt:g>items</wbt:g>
            <div style="float: right;margin-right:10px;font: 15px solid;color:#fff5e2">
                <button id="btn_add_item" type="button"
                        class="layui-btn layui-btn-sm layui-border-blue layui-btn-disabled"
                        onclick="add_or_edit_item(null)">+<wbt:g>add</wbt:g></button>
            </div>
        </blockquote>
    </div>
...
<script>
    ...
    function del_item(id) {
        if (event)
            event.stopPropagation();
        let ob = $("#p_" + id);
        dlg.confirm('<wbt:g>del,this,ui,item</wbt:g> [' + ob.attr("n") + ']?', {
