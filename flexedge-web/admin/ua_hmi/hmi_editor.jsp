...
<div class="top " style="background-color: #cccccc">
    <div style="float: left;position:relative;left:0px;margin-left:5px;top:2px;font: 30px solid;color:#0092c8">IOTTree
        HMI Editor
    </div>
    ...
    <i class="fa fa-cog fa-3x  top_btn"
       onclick="add_tab('11','ttt','hmi_editor_comp.jsp?catid=<%=repid %>&id=<%=id%>')"></i>
    ...
    <div class="layui-tab" lay-filter="tab_hmi_editor" lay-allowclose="true">
        ...
        <div class="layui-tab-content" style="bottom:0px">
            <div class="layui-tab-item layui-show"
                 style="position: fixed;height0:700px;left:0px;bottom:0px;top:80px;right:0px">
                <iframe id="if_main" src="hmi_editor_ui.jsp?tabid=main&repid=<%=repid %>&id=<%=id%>"
