    ...
    <table id="top_oper">
        <tr>
            ...
            <td>
                <form class="layui-form" action="">
                    <select id="lib_ids" name="lib_ids" lay-filter="lib_ids" style="width:50px">
                        ...
                        %>
                        <option value="<%=dl.getId()%>" <%=sel %>><%=dl.getTitle() %>
                        </option>
                        <%
                            }
                        %>
            ...
            <td style="padding-left: 15px;">
                <button id="top_oper_add_cat" type="button" class="layui-btn layui-btn-sm layui-btn-primary"
    ...
    $('#btn_menu_lib').click(function () {
        $(this).selectMenu({
            ...
            data: [
                ...
                {
                    content: 'Edit Current Lib', callback: function () {
                        lib_edit();
                    }
                },
                {
                    content: 'Add Library', callback: function () {
                        lib_add();
                    }
                },
                {content: 'Category', header: true},
                {
                    content: 'Add Category', callback: function () {
                        lib_add_edit_cat();
                    }
                }
            ]
