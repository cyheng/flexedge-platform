            ...
            <div class="layui-tab layui-tab-brief" lay-filter="tab_hmi_editor" lay-allowclose="true"
                ...
                <div class="layui-tab-content" style="position:relative;bottom:0px;height:100%">
                    <div class="layui-tab-item layui-show"
                        ...
                        <iframe id="if_rep" border="0" src="rep.jsp?tabid=main&id=<%=repid %>"
                                src0="rep_editor.jsp?tabid=main&id=<%=repid %>"
                    ...
                    <div class="layui-tab-item" style="position:relative;top:0px;bottom:0px;width:100%;height:100%">
                        <iframe id="if_main" src="rep_editor_graph.jsp?tabid=main&id=<%=repid %>"
                                style="width:100%;height:100%;border:0px"></iframe>
                    </div>
...
<script>
    ...
    var cxt_menu = {
        "rep": [
            ...
            {
                op_name: "new_tag_exp",
                op_title: "<wbt:lang>new_tag_mid</wbt:lang>",
                op_icon: "fa fa-compass",
                op_action: ""
            },
            {
                op_name: "open_cxt",
                op_title: "<wbt:lang>data_cxt</wbt:lang>",
                op_icon: "fa fa-list-alt",
                op_action: act_open_data_cxt
            },
            {
                op_name: "prop",
            ...
            {
                op_name: "mem_add_conn",
                op_title: "<wbt:lang>add_conn</wbt:lang>",
                op_icon: "fa fa-refresh",
                op_action: ""
            }
        ],
    ...
    function act_prop(n, op) {
        dlg.open_win("ua/ui_prop.jsp?repid=" + repid + "&id=" + n.id,
            ...
            ['Ok', {title: 'Apply', style: "warm", enable: false}, {title: 'Cancel', style: "primary"}, {
                title: 'Help',
                style: "primary"
            }],
            [
