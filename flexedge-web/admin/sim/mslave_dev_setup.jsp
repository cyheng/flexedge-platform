...
<b>Segments</b>
<table id="view_colorval" class="layui-table" lay-filter="dl_list" lay-size="sm" lay-even="true" style="width:95%"
       border="1">
    ...
    <tr>
        <td>
            <select id="sel_fc">
                ...
                %>
                <option id="fc_<%=k %>" fc_t="<%=t %>" value="<%=k%>"><%=t %>
                </option>
                <%
                    }
                %>
        ...
        <td><input id="input_regidx" type="number" size="2" style="width:50px" onchange="fit_num('input_regidx',0)"/>
        </td>
        <td><input id="input_regnum" type="number" size="10" style="width:50px" onchange="fit_num('input_regnum',1)"/>
        </td>

        <td style="width:5%"><a href="javascript:add_item()"><i class="fa fa-plus fa-lg" aria-hidden="true"></i></a>
        </td>
    </tr>
    </tfoot>
</table>
