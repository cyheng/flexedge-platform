...
function UATree(tree_opt) {
    ...
    this.get_cxt_menu = function (tp, tn) {
        ...
        if (r != undefined && r != null)
            return r;
        r = {};
        for (var op of tmp) {//{op_name:"new_dev",op_title:"xxx",op_icon:"fa fa-tasks fa-lg",action:act_ch_new_dev}
            ...
            r[op_name] = {
                op_name: op_name,
                op_action: op.op_action,
                label: op.op_title,
                icon: op.op_icon,
                "separator_after": true,
                action: UATree_CXTMENU_ACT
            };
        }
        //this.cxt_menu[tp] =r ;
        return r;
