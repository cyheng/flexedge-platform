    ...
    <tr>
        <td style="width:50%">
            <div id="prop_edit_path" class="prop_edit_path">Source Input&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="layui-btn layui-btn-xs layui-btn-primary" title="input <%=sor_tp %> text"
                        onclick="input_txt()"><i class="fa-solid fa-eye-dropper"></i><%=sor_tp %>
                </button>
                <%--
            ...
            <table style="border:0px;height:100%">
                ...
                <tr style="height:100%;border:solid 0px">
                    <td style="width:5%;vertical-align:middle;">
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="probe_or_not(true)"
                                title="extract data"><i class="fa-solid fa-arrow-right"></i></button>
                        <br>
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="probe_or_not_all(true)"
                                title="extract all data"><i class="fa-solid fa-arrow-right"></i><br><i
                        ...
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="copy_map()" title="copy create tag and bind"><i class="fa fa-angles-right"></i><br><i class="fa fa-tag"></i></button><br><br>
                         --%>
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="probe_or_not(false)"
                                title="unextract data"><i class="fa-solid fa-arrow-left"></i></button>
                    </td>
                    <td style="width:95%;vertical-align: top;height:100%">
                        <div id="prop_edit_path" class="prop_edit_path">Probed List &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button id="btn_tag_syn" class="layui-btn layui-btn-xs layui-btn-primary" title="export"
                                    onclick="bind_export()"><i class="fa-solid fa-arrow-up"></i>&nbsp;&nbsp;<i
                                    class="fa fa-tag"></i></button>
                            <button id="" class="layui-btn layui-btn-xs layui-btn-primary" title="import"
                                    onclick="bind_import()"><i class="fa-solid fa-arrow-down"></i>&nbsp;&nbsp;<i
                                    class="fa fa-tag"></i></button>
                            <button id="" class="layui-btn layui-btn-xs layui-btn-primary" title="add tag in channel"
