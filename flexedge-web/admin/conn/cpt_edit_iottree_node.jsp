...
<form class="layui-form" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 150px;">
            <input type="text" id="mqtt_psw" name="mqtt_psw" value="<%=psw%>" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="share_prjid" name="share_prjid" value="<%=share_prjid%>" lay-verify="required"
                   autocomplete="off" class="layui-input">
        </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: conn_id, name: n, title: tt, desc: desc, enable: ben, prjid: prjid, mqtt_host: host, mqtt_port: vp,
