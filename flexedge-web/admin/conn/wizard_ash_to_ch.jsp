...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid">
            <button id="btn_add_devdef" title="add device" type="button" class="layui-btn layui-btn-sm"
                    onclick="sel_devdef()"><i class="fa fa-plus"></i></button>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <table id="view_colorval" class="layui-table" lay-filter="dl_list" lay-size="sm" lay-even="true"
                ...
                <td style="width:15%"><input id="input_id" type="hidden" value=""/><input id="input_connid" type="text"
                                                                                          size="4"/></td>
