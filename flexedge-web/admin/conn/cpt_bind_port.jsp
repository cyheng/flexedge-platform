...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 150px;">
            <input type="checkbox" id="ignore_null" name="ignore_null" checked='checked' lay-skin="switch"
                   lay-filter="ignore_null" class="layui-input">
        </div>
        <div class="layui-form-mid"><w:g>auto_c_tag</w:g>:</div>
        <div class="layui-input-inline" style="width: 150px;">
            <input type="checkbox" id="auto_create_tag" name="auto_create_tag" checked='checked' lay-skin="switch"
                   lay-filter="auto_create_tag" class="layui-input">
        </div>
    </div>
    <%
    } else {
