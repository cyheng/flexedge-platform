    ...
    <tr>
        <td style0="width:55%">
            <div id="prop_edit_path" class="prop_edit_path">HTML Trace and Extract&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <button class="layui-btn layui-btn-xs layui-btn-primary" title="Add Block Locator"
                        onclick="edit_block()"><i class="fa-solid fa-plus"></i>Add Block Locator
                </button>
            ...
            <div id="left_cont" class="prop_edit_cat" style="height:420px;width:500px;">
                <div class="bl_item">
                    ...
                    <button class="layui-btn layui-btn-xs layui-btn-primary" onclick="edit_block(‘b1’)"
                            style="float:right;right:5px;top:5px;position:relative;"><i class="fa-solid fa-pencil"></i>Edit
                    </button>
