        ...
        <td style="width:50%">
            <div id="prop_edit_path" class="prop_edit_path">[<%=cptp %>] <%=cp.getName() %>/<%=cpt.getName() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button id="btn_tree_list" class="layui-btn layui-btn-xs layui-btn-primary" title="set tree or list"
                        onclick="set_tree_list()"><i class="fa-solid fa-folder-tree"></i></button>
                <%--
                        <button class="layui-btn layui-btn-xs layui-btn-primary" title="set bind parameters" onclick="set_bind_pm()"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                         --%>
                <button class="layui-btn layui-btn-xs layui-btn-primary" title="refresh" onclick="show_tree(true)"><i
            ...
            <table style="border:0px">
                <tr style="height:30%;border:solid 0px">
                    <td style="width:5%;vertical-align:middle;">
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="sel_or_not(true)"><i
                                class="fa-solid fa-arrow-right"></i></button>
                        <br><br>
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="sel_or_not(false)"><i
                    ...
                    <td style="width:95%;vertical-align: top;height:50%">
                        <div id="prop_edit_path" class="prop_edit_path">Bind Copy&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button id="btn_tag_syn" class="layui-btn layui-btn-xs layui-btn-primary"
                                    title="create tag groups and tags" onclick="syn_tag_ch()"><i
                                    class="fa fa-angles-right"></i>&nbsp;&nbsp;<i class="fa fa-tag"></i></button>
                        </div>
                        <div id="" class="prop_edit_panel" style="height:170px">
                            <select multiple="multiple" id="bind_selected"
                                    style="width:100%;height:100%;overflow: auto;">
                                <%
                                    for (String tmps : bindids) {
                                %>
                                <option value="<%=tmps %>"><%=tmps %>
                                </option>
                                <%
                                    }
                                %>
                ...
                <tr style="height:70%;border:solid 0px">
                    <td style="width:5%;vertical-align:middle;">
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="map_or_not(true)"><i
                                class="fa-solid fa-arrow-right"></i></button>
                        <br><br>
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="map_or_not(false)"><i
                                class="fa-solid fa-arrow-left"></i></button>
                    </td>
