...
<table width='100%' height='99%'>
    <tr>
        <td width="70%">
            <iframe id="dev_lister" src="../dev/dev_lib_lister.jsp?hide_drv=true&drv=<%=drv%>" width="100%"
        ...
        <td width="30%" valign="top">
            ...
            %>
            <br/> <%=pi.getTitle() %><input id="pgdev_<%=pi.getName() %>" pi_tp="dev" pg_name="<%=pg.getName() %>"
                                            pi_name="<%=pi.getName() %>" value="<%=defv %>" class="pitem"/>
            <%
                        }
                    }
                }
