...
<form class="layui-form" action="">
    ...
    Trace Info
    <table id="view_colorval" class="layui-table" lay-filter="dl_list" lay-size="sm" lay-even="true"
           style="margin-left:30px;width:80%" border="1">
        ...
        <tr id="lk_">
            ...
            <td>
                ...
                <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit basic"
                        onclick="edit_devdef('<%=""%>')"><i class="fa fa-pencil"></i></button>
