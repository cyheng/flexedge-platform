...
<form class="layui-form" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ()=&gt;
            <textarea id="script" name="script" lay-verify="required" placeholder="" class="layui-textarea"
                      rows="10"><%=script%></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ("$tag","$value")=&gt;
            <textarea id="on_w_script" name="on_w_script" lay-verify="required" placeholder="" class="layui-textarea"
                      rows="10"><%=ow_script%></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">Description:</label>
        <div class="layui-input-block">
            <input id="desc" name="desc" lay-verify="required" placeholder="" class="layui-input"
                   value="<%=Convert.plainToHtml(desc)%>"/>
        </div>
    </div>
