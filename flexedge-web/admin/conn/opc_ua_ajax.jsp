...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="opc_host" name="opc_host" value="<%=host%>" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
        <div class="layui-form-mid">Opc Host Port:</div>
        <div class="layui-input-inline" style="width: 70px;">
            <input type="text" id="opc_port" name="opc_port" value="<%=port%>" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
        <div class="layui-form-mid">Opt Request Timeout:</div>
        <div class="layui-input-inline" style="width: 70px;">

            <input type="text" id="opc_req_to" name="opc_req_to" value="<%=opc_reqto%>" lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 70px;">
            <input type="text" id="opc_proto" name="opc_proto" value="<%=opc_proto%>" lay-verify="required"
                   autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-mid">Opc Path:</div>
        <div class="layui-input-inline" style="width: 150px;">
            <input type="text" id="opc_path" name="opc_path" value="<%=opc_path%>" lay-verify="required"
                   autocomplete="off" class="layui-input">
        </div>
  ...
  <div class="layui-form-mid">Opt Request Timeout:</div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="opc_user" name="opc_user" value="<%=opc_user%>" lay-verify="required"
                   autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-mid">Opc Password:</div>
        <div class="layui-input-inline" style="width: 150px;">
            <input type="text" id="opc_psw" name="opc_psw" value="<%=opc_psw%>" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: conn_id, name: n, title: tt, desc: desc, enable: ben, opc_host: host, opc_port: vp,
