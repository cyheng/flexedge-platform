...
<form class="layui-form" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <textarea id="topics" name="topics" class0="layui-textarea"
                      style="height:70px;width:350px;border-color: #e6e6e6"><%=topics_str%></textarea>
        </div>
    </div>
    <%--
   <div class="layui-form-item">
 ...
 %>
   ...
   --%>
    ...
    <iframe id="if_msg" src="cpt_edit_msg.jsp?prjid=<%=repid%>&cpid=<%=cpid%>&connid=<%=cid%>"
            style="width:100%;height:270px;border:0px;overflow: hidden;"></iframe>
    <div class="layui-form-item">
