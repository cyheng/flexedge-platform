...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width:700px">
        <textarea id=xml_str name="xml_str"
                  style="height:30px;width:100%;height:400px;border-color: #e6e6e6;overflow:scroll;"><%=Convert.plainToHtml(xmlstr, false)%></textarea>
    </div>
</div>
</body>
