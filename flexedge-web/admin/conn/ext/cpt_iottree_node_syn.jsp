...
<div class="ppt">
    ...
    %>
    <div style="font-size: 15px;color:blue;"><wbt:g>pls_start_syn_btn</wbt:g>.<span
            style="color:red;"><wbt:g>syn_overw_pt</wbt:g></span>!
    </div>
    <%
        }
...
<div class="sel_item">
    <button style="width:80%" class="layui-btn  <%=btn_disb %>" title="" onclick="do_syn()"><i id="ico_syn"
                                                                                               class="fa fa-refresh"
                                                                                               aria-hidden="true"></i><wbt:g>start_syn</wbt:g>
    </button>
</div>
<div class="sel_item">
