...
<table class="prop_table">
    <tr>
        <td colspan="3">
            <div id="prop_edit_path" class="prop_edit_path">[<%=cptp %>] <%=cp.getName() %>/<%=cpt.getName() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="layui-btn layui-btn-xs layui-btn-primary" title="set bind parameters"
                        onclick="set_bind_pm()"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                <button class="layui-btn layui-btn-xs layui-btn-primary" title="refresh" onclick="refresh_tree()"><i
    ...
    <tr>
        ...
        <td style="width:5%;vertical-align:middle;">
            <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="send_out()">&gt;&gt;</button>
            <br><br>
