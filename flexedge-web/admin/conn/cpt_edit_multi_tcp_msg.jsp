...
<form class="layui-form" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" id="recv_broken_to" name="recv_broken_to" value="<%=recv_broken_to%>"
                   class="layui-input"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 150px;">
                <select id="loc_ip" lay-filter="loc_ip">
                    ...
                    %>
                    <option value="<%=adp.getIp4()%>"><%=adp.getIp4()%>
                    </option>
                    <%
                        }
                    %>
    ...
    <div id="tcp_run_tp_c" style="display:none">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:80%">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="remote_host" name="remote_host" value="" style="height:28px"
                           class="layui-input">
                </div>
                <div class="layui-form-mid" style="height:28px"><wbt:g>port</wbt:g>:</div>
                <div class="layui-input-inline" style="width: 80px;">
                    <input type="number" id="remote_port" name="remote_port" value="" style="height:28px"
                           class="layui-input">
                </div>
                <div class="layui-form-mid">
                    <button class="layui-button" onclick="set_addr_tcp_run_c()"><i class="fa fa-plus "></i></button>
                </div>
            </div>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:150px">
            <select id="data_pro_tp" lay-filter="data_pro_tp">
                ...
                %>
                <option value="<%=tdp.getTP()%>"><%=tdp.getTPT() %>
                </option>
                <%
    ...
    <div class="layui-form-item" id="data_pro_tp_sp">
        ...
        <div class="layui-input-inline" style="width:30px;">
            <input type="checkbox" id="keep_s" name="keep_s"  <%=(keep_s?"checked":"") %> class="layui-input"
                   lay-skin="primary">
        </div>
        ...
        <div class="layui-form-mid">Keep</div>
        <div class="layui-input-inline" style="width:30px;">
            <input type="checkbox" id="keep_e" name="keep_e" <%=(keep_e?"checked":"") %> class="layui-input"
                   lay-skin="primary">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: conn_id, name: n, title: tt, desc: desc, enable: ben, recv_broken_to: recv_broken_to,
