...
<form class="layui-form" onsubmit="return false;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:90px">
            <select id="sor_tp" lay-filter="sor_tp">
                ...
                %>
                <option value="<%=stp.toString()%>"><%=stp.getTitle()%>
                </option>
                <%
                    }
                %>
        ...
        <div class="layui-input-inline" style="width:90px">
            <select id="encod" lay-filter="encod">
                ...
                %>
                <option value="<%=chartset%>"><%=chartset%>
                </option>
                <%
                    }
                %>
        ...
        <div class="layui-input-inline" style="width:150px;white-space: nowrap;">
            <select id="handle" lay-filter="handle">
                ...
                %>
                <option value="<%=st.toString() %>"><%=st.getTitle() %>
                </option>
                <%
                    }
                %>
    ...
    <div id="run_page_cont" class="layui-form-item" style="display:none">
        ...
        <div class="layui-input-inline" style="width: 50px;">
            <input type="checkbox" id=run_js_page name="run_js_page" <%=run_js_page_chk%> lay-skin="switch"
                   lay-filter="enable" class="layui-input">
        </div>
    ...
    <div id="run_page_cont" class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:90px">
            <input type="button" id="btn_readtobuf" name="btn_readtobuf" value="Read"
                   class="layui-btn layui-btn-warm layui-border-blue layui-btn-sm" onclick="read_to_buf()">
        </div>
    ...
    <div id="edit_trans_js">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px">
                <textarea id="init_js" name="init_js"
                          style="height:30px;width:100%;border-color: #e6e6e6"><%=init_js%></textarea>
            </div>
            <button onclick="edit_js_init()"
                    class="layui-btn layui-btn-<%=(true?"normal":"primary") %> layui-border-blue layui-btn-sm">...
            </button>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px">
                ($topic,$msg)=>{
                <textarea id="trans_js" name="trans_js" class="layui-textarea"
                          style="height:50px"><%=trans_js%></textarea>
                }
            </div>
            <button onclick="edit_js_trans()"
                    class="layui-btn layui-btn-<%=(true?"normal":"primary") %> layui-border-blue layui-btn-sm">...
            </button>
        </div>
    </div>
    ...
    <div id="edit_bind" style="display:none">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:100px">
                <button onclick="probe_setup()"
                        class="layui-btn layui-btn-<%=(true?"normal":"primary") %> layui-border-blue layui-btn-sm">Data
                    Probe
                </button>
            </div>
            <label class="layui-form-label" style="width:150px">Bind Channel:</label>
            <div class="layui-input-inline" style="width:100px">
                <button onclick="bind_to_ch()"
                        class="layui-btn layui-btn-<%=(true?"normal":"primary") %> layui-border-blue layui-btn-sm">Bind
                    Channel
                </button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            sor_tp: sor_tp, handle: h, init_js: init_js, trans_js: trans_js, encod: enc,
