...
<form class="layui-form" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 250px;">
            <input type="text" id="chk_pros" name="chk_pros" value="<%=chk_pros %>" autocomplete="off"
                   class="layui-input" title="<wbt:g>dbclk,select</wbt:g>" ondblclick="sel_pro()">
        </div>
        <div class="layui-form-mid">Failed Reboot</div>
        <div class="layui-input-inline" style="width: 50px;">
            <input type="checkbox" id="chk_pros_reboot" name="chk_pros_reboot" lay-skin="switch"
                   lay-filter="chk_pros_reboot"  <%=chk_pros_reboot?"checked":"" %> autocomplete="off"
                   class="layui-input">
        </div>
        <div class="layui-form-mid">After(MS)</div>
        <div class="layui-input-inline" style="width: 100px;">
            <input type="number" id="chk_pros_reboot_after" name="chk_pros_reboot_after"
                   value="<%=chk_pros_reboot_after %>" autocomplete="off" class="layui-input">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        let pm = {
            ...
            int_ms: int_ms,
            chk_pros: chk_pros,
            chk_pros_reboot: chk_pros_reboot,
            chk_pros_reboot_after: chk_pros_reboot_after
        };
