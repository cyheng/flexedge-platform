                ...
                <%--
                 <button id="btn_tree_list" class="layui-btn layui-btn-xs layui-btn-primary" title="set tree or list" onclick="set_tree_list()"><i class="fa-solid fa-folder-tree"></i></button>
                        <button class="layui-btn layui-btn-xs layui-btn-primary" title="set bind parameters" onclick="set_bind_pm()"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                         --%>
                <button class="layui-btn layui-btn-xs layui-btn-primary" title="refresh"
                        onclick="refresh_tb_list(true)"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-filter"></i><input type="text" id="inp_search" size="10"
                                                                                 onkeydown="do_search_ret(event)"/>
                <button class="layui-btn layui-btn-xs layui-btn-primary" onclick="search()" title="<w:g>filter</w:g>"><i
                        class="fa-solid fa-magnifying-glass"></i></button>
                <select id="prefix_sel" style="border-color:#00bdad;color:#00bdad;max-width:100px;"
                        onchange="on_filter_prefix_chg(this)" title="<w:g>select,filter</w:g>"></select>
                <button id="btn_clear" class="layui-btn layui-btn-xs layui-btn-primary " onclick="search(true)"
                        title="<w:g>clear,filter</w:g>"><i class="fa-solid fa-eraser"></i></button>
                <%
                    if (support_tree) {
                %>
                <button id="btn_tree_list" class="layui-btn layui-btn-xs layui-btn-primary" title="set tree or list"
                        onclick="set_tree_or_tb()"><i class="fa-solid fa-folder-tree"></i></button>
                <%
                    }
                %>
            </div>
              ...
              %>
                ...
                <tr style="height:100%;border:solid 0px">
                    <td style="width:5%;vertical-align:middle;background-color: #f0f0f0">
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="map_or_not(true)"
                                title="bind to tag"><i class="fa-solid fa-arrow-right"></i></button>
                        <br><br>
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="map_copy()"
                                title="copy create tag and bind"><i class="fa fa-angles-right"></i><br><i
                                class="fa fa-tag"></i></button>
                        <br><br>
                        <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="map_or_not(false)"
                                title="unbind from tag"><i class="fa-solid fa-arrow-left"></i></button>
                    </td>
                    <td style="width:95%;vertical-align: top;height:100%">
                        <div id="prop_edit_path" class="prop_edit_path"><w:g>bind_map</w:g> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button id="btn_tag_syn" class="layui-btn layui-btn-xs layui-btn-primary"
                                    title="<w:g>export</w:g>" onclick="bind_export()"><i
                                    class="fa-solid fa-arrow-up"></i>&nbsp;&nbsp;<i class="fa fa-tag"></i></button>
                            <button id="" class="layui-btn layui-btn-xs layui-btn-primary" title="<w:g>import</w:g>"
                                    onclick="bind_import()"><i class="fa-solid fa-arrow-down"></i>&nbsp;&nbsp;<i
                                    class="fa fa-tag"></i></button>
                            <button id="" class="layui-btn layui-btn-xs layui-btn-primary "
                                    style="border-color:#00bdad;color:#00bdad;" title="<w:g>add_tag_in_ch</w:g>"
                                    onclick="add_tag()"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;<i
                                    class="fa fa-tag"></i></button>
                        </div>
                        <div id="" class="prop_edit_panel" style="height:560px">
                            <table style="width:100%;overflow: auto;">
                                ...
                                <tr style="border:solid 1px;height:15px" tagp="<%=tagp%>" bindp="<%=c_p%>">
                                    ...
                                    <td title="<%=tag.getTitle()%>"><%=tagp %>:<%=vtstr %>
                                    </td>
                                    <td></td>
                                </tr>
                                <%
