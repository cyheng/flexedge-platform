...
<form class="layui-form" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 70px;">
            <input type="text" id="mqtt_port" name="mqtt_port" value="<%=port%>" lay-verify="required"
                   autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-mid">Conn Timeout:</div>
        <div class="layui-input-inline" style="width: 70px;">

            <input type="text" id="mqtt_conn_to" name="mqtt_conn_to" value="<%=conn_to%>" title="seconds"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function do_submit(cb) {
        ...
        cb(true, {
            id: cp_id, name: n, title: tt, desc: desc, enable: ben, mqtt_host: host, mqtt_port: vp,
