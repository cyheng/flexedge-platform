...
<%@ page import="java.util.*,
                 ...
                 cn.doraro.flexedge.core.conn.html.*,
    ...
    <tr>
        <td colspan="5">
            <div id="prop_edit_path" class="prop_edit_path" style="height:50px">&nbsp;
                URL:<input type="text" id="input_url" name="input_url" style="width:70%" value=""
    ...
    <tr>
        <td style="width:45%;vertical-align: top;">
            <div id="" class="prop_edit_path" style="height0:100px">Trace Points:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <button class="layui-btn layui-btn-xs " title="input " onclick="set_trace_pt_clk()"><i
                        class="fa-solid fa-plus"></i>Set Trace Point
                </button>
                <button class="layui-btn layui-btn-xs layui-btn-warm" title="input " onclick="do_trace()"><i
                        class="fa-solid fa-eye-dropper"></i>Trace Root
                </button>
                <span id="trace_info"></span>
                &nbsp;<span id="uplvl_info" style="font:bold;color:blue">0</span>
                <button class="layui-btn layui-btn-xs layui-btn-normal" title="input " onclick="do_uplvl(true)"><i
                        class="fa-solid fa-arrow-up"></i>Upper Level
                </button>
                <button class="layui-btn layui-btn-xs layui-btn-normal" title="input " onclick="do_uplvl(false)"><i
                        class="fa-solid fa-arrow-down"></i>Down Level
                </button>
            </div>
            <%--
                ...
                <tr style="width:100%;height:100%;border:solid 0px">
                    <td style="width:100%;vertical-align: top;height:100%">
                        ...
                        <div id="prop_edit_path" class="prop_edit_path">Extractable data:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Name:<input id="ep_name" style="width:100px"/> Title:<input id="ep_title"
                                                                                        style="width:100px"/>
                            <button id="btn_tag_syn" class="layui-btn layui-btn-xs layui-btn-primary" title="export"
                                    onclick="set_extract()"><i class="fa-solid fa-arrow-up"></i>&nbsp;&nbsp;<i
...
<script type="text/javascript">
    ...
    function do_trace() {
        ...
        send_ajax("./html/html_ajax.jsp", {
            op: "trace", bfp: tmpbuf_fp, run_js_page: run_js.run_js_page, run_js_to: run_js.run_js_to,
            jstr: JSON.stringify(curbk)
        }, function (bsucc, ret) {
