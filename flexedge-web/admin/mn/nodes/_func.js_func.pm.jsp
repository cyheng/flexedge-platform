        ...
        <div class="layui-tab" lay-filter="js_tabs" style="width:100%;margin:0px;">
            ...
            <div class="layui-tab-content" style="padding:0px;">
                <div class="layui-tab-item" id="tab_init_js">
                    ...
                    <div id='init_js'
                         style="overflow: scroll;width:100%;height:520px;border:0px solid #e6e6e6;margin-top:2px;"></div>

                </div>
                <div class="layui-tab-item  layui-show">
                    <span style="color:#229ecc">function</span> <span
                        style="color:#ffcc9e;font-weight: bold;">on_msg_in</span>(<span class="pm"
                                                                                        title="In Msg's Topic">topic</span>,<span
                        class="pm" title="In Msg's Heads">heads</span>,<span class="pm"
                                                                             title="In Msg's Payload">payload</span>,<span
                        class="pm" title="this runing node">node</span>,<span class="pm"
                                                                              title="This Flow/Net">flow</span>) <span
                        style="color:#901f1f">{</span>
                    <div id='run_js'
                         style="overflow: scroll;width:100%;height:520px;border:0px solid #e6e6e6;margin-top:2px;"></div>
                ...
                <div class="layui-tab-item">
                    <span style="color:#229ecc">function</span> <span
                        style="color:#ffcc9e;font-weight: bold;">on_end</span>(<span class="pm"
                                                                                     title="this runing node">node</span>,<span
                        class="pm" title="This Flow/Net">flow</span>) <span style="color:#901f1f">{</span>
                    <div id='end_js'
                         style="overflow: scroll;width:100%;height:520px;border:0px solid #e6e6e6;margin-top:2px;"></div>
                    <span style="color:#901f1f">}</span>
                </div>
