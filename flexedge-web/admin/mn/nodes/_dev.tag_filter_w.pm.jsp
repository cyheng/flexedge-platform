...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="overflow: auto;width:350px;">
        <textarea style="width:100%;height:200px;" id="tags" readonly="readonly" onclick="sel_tags()"
                  class="layui-input"><%=pss %></textarea>
    </div>
    <div class="layui-form-mid">
        <button onclick="sel_tags()">...</button>
    </div>
</div>
...
<script>
    ...
    function set_pm_jo(jo) {// no path show
        tagids = jo.tagids || [];
