...
<div class="row">
    ...
    <div class="nor_sel" style="width:250px;">
        <select id="out_tp" class="layui-input" lay-filter="out_tp" style="border-right: 0px;">
            ...
            %>
            <option value="<%=pktp.name()%>"><%=pktp.getTitle() %>
            </option>
            <%
                }
            %>
...
<div class="row">
    ...
    <div class="nor_sel" style="">
        <input type="text" id="col_names" class="layui-input" style="width:380px;border-left: 0px;left0:2px;"
               title="like col1,col2,xx.yy,col4"/>
    </div>
