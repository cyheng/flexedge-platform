...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline " id="filter_list" style="width:250px;">
        <input type="text" id="sub_root_path" name="sub_root_path" value="" readonly autocomplete="off"
               class="layui-input" onclick="sel_sub_root(this)">
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width:400px;border:0px solid;">
        ...
        %><%=pd.getPropTitle() %><input type="checkbox" id="c_exts_<%=pd.getPropName() %>" name="c_exts"
                                        lay-skin="primary" value="<%=nn %>" <%=(c_exts.contains(nn) ?"checked":"") %>><%
            }
        }
    %>
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width:400px;">
        ...
        %><%=pd.getPropTitle() %><input type="checkbox" id="tag_exts_<%=pd.getPropName() %>" name="tag_exts"
                                        value="<%=nn %>" lay-skin="primary" <%=(tag_exts.contains(nn) ?"checked":"") %>><%
            }
        }
    %>
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width:150px;">
        <input type="checkbox" id="_b_flat_out" name="_b_flat_out" lay-skin="primary" lay-filter="_b_flat_out"
               class="layui-input">List out
    </div>
</div>
<script>
