...
<div class="layui-form-item">
    ...
    <div class="layui-form-mid"><input type="checkbox" class="layui-input" id="b_delay" lay-skin="primary"/>trigger once
        after
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width:250px;">
        <select id="repeat_tp" name="repeat_tp" class="layui-input" lay-filter="repeat_tp">
            ...
            %>
            <option value="<%=rt.getInt()%>"><%=rt.getTitle() %>
            </option>
            <%
                }
            %>
...
<div id="bt_cont">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:450px;">
            ...
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.MONDAY %>"
                   value="<%=Calendar.MONDAY %>" name="on_week"/><w:g>monday</w:g>
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.TUESDAY %>"
                   value="<%=Calendar.TUESDAY %>" name="on_week"/><w:g>tuesday</w:g>
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.WEDNESDAY %>"
                   value="<%=Calendar.WEDNESDAY %>" name="on_week"/><w:g>wednesday</w:g>
            <br>
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.THURSDAY %>"
                   value="<%=Calendar.THURSDAY %>" name="on_week"/><w:g>thursday</w:g>
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.FRIDAY %>"
                   value="<%=Calendar.FRIDAY %>" name="on_week"/><w:g>friday</w:g>
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.SATURDAY %>"
                   value="<%=Calendar.SATURDAY %>" name="on_week"/><w:g>saturday</w:g>\
            <br>
            <input type="checkbox" class="layui-input" lay-skin="primary" id="on_week_<%=Calendar.SUNDAY %>"
                   value="<%=Calendar.SUNDAY %>" name="on_week"/><w:g>sunday</w:g>
        </div>
    </div>
</div>
<script>
    ...
    function get_pm_jo() {
        ...
        return {
            b_delay: b_delay, delay_ms: delay_ms, repeat_tp: repeat_tp, interval_ms: interval_ms,
