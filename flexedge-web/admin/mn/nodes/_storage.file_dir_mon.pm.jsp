...
<div class="row">
    ...
    <div class="nor_sel" style="">
        <select id="out_tp" class="layui-input" lay-filter="out_tp" style="width:100px;border-right: 0px;">
            ...
            %>
            <option value="<%=pktp.getInt()%>"><%=pktp.getTitle() %>
            </option>
            <%
                }
            %>
...
<div class="row">
    ...
    <div class="tar_pktp" style="">
        <select id="mvtodir_valsty" class="layui-input" lay-filter="mvtodir_valsty"
...
<script>
    ...
    function get_pm_jo() {
        ...
        return {
            path_valsty: path_valsty, path_subv: path_subv, fn_prefix: fn_prefix, fn_suffix: fn_suffix,
