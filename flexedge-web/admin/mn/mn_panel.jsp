...
<div class="cont">
    ...
    <%
        if (true) {
            String catn = "flow";
    %>
    <div class="citem" id="cat_<%=catn%>" onclick="show_hiddle(this)" cat_n="<%=catn%>"><span id="cat_i_<%=catn%>"><i
            class="fa fa-angle-down"></i></span> <w:g>flow</w:g></div>
    <div id="cat_list_<%=catn%>">
        <form class="layui-form" onsubmit="return false;">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width:100px;">
                    <input type="checkbox" class="layui-input" lay-skin="primary" id="flow_enable"  <%=net_en_chk %>/>
                    Enable
                </div>
            </div>
        </form>
    ...
    <div class="citem" id="cat_<%=catn%>" onclick="show_hiddle(this)" cat_n="<%=catn%>"><span id="cat_i_<%=catn%>"><i
            class="fa fa-angle-down"></i></span> <w:g>rt_vars</w:g></div>
    <div id="cat_list_<%=catn%>">
        当前节点变量
        <table>
    ...
    <div class="citem" id="cat_<%=catn%>" onclick="show_hiddle(this)" cat_n="<%=catn%>"><span id="cat_i_<%=catn%>"><i
            class="fa fa-angle-down"></i></span> <w:g>pm_st</w:g></div>
    <div id="cat_list_<%=catn%>">
        <table>
        </table>
    </div>
