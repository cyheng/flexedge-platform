...
<head>
    ...
    <style>
        ...
        / / display: none;
            ...
            box-shadow: 0 0 10px 2px #4d5053;
        / / #bdcee0;
        }
...
<div class="cont">
    ...
    %>
    <div class="citem" id="cat_<%=cat.getName()%>" onclick="show_hiddle(this)" cat_n="<%=cat.getName()%>"><span
            id="cat_i_<%=cat.getName()%>"><i class="fa fa-angle-down"></i></span> <%=cat.getTitle() %>
    </div>
    <div id="cat_list_<%=cat.getName()%>">
        ...
        %>
        <div class="nitem" id="n_<%=fulltp%>" tp_tp="node" tptp="n" _tp="<%=fulltp%>" draggable='true'
        ...
        %>
        <div class="nitem" style="height:60px;" id="m_<%=fulltp%>" tp_tp="module" tptp="m" _tp="<%=fulltp%>"
...
<script type="text/javascript">
    ...
    function drag(ev) {
        ...
        var r = {
            _val: {tp: tp, moduleid: moduleid, x_ratio: x / w, y_ratio: y / h, x_offset: x, y_offset: y},
            _tp: tptp
        };
    ...
    function slide_toggle(obj, h) {
        ...
        {
            obj.animate({height: '0px', opacity: 'hide'}, 'normal', function () {
                obj.hide();
            });
            //obj.attr('topm_show',"0") ;
            return 0;
        } else {
            obj.animate({height: h + "px", opacity: 'show'}, 'normal', function () {
                obj.show();
            });
