...
<head>
    ...
    <script type="text/javascript">
        ...
        function on_init_pm_ok() {// called by sub pm js
...
<%
    if (can_save) {
%>
<button class="layui-btn layui-btn-sm layui-btn-primary save_btn" title="<w:g>save_to_lib</w:g>"
        onclick="save_to_lib()"><i class="fa fa-arrow-right fa-lg"></i><i class="fa fa-book fa-lg"></i></button>
<%
    }
%>
