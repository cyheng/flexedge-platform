...
<div id="leftcat_comp" class="show_hid_icon" style="left:0px;" onclick="show_hiddle_left()"
     title="show or hidden left panel"><i class="fa fa-cogs fa-lg lr_btn"></i><br>&nbsp;
</div>
<div id="left_panel" class="left_panel_win">
    ...
    <iframe id="left_pan_iframe" src="mn_node_list.jsp?container_id=<%=container_id %>"
            style="width:100%;top:0px;height:300px;overflow:hidden;margin: 0px;border:0px solid;padding: 0px;"></iframe>
</div>
<div id="mid" class="mid">
    <div id="panel_main"
         style="border: 1px solid #cccccc;margin:0px; width: 100%; height: 100%; background-color: #ffffff;overflow: hidden;"
         title="">
        <div id="prompt_p" class="prompt_p"></div>

    </div>

    <div style="right:0px;" class="show_hid_icon" title="show or hide right panel" id="btn_prop_showhidden"><i
            class="fa fa-bars fa-lg"></i></div>
    <div id='edit_panel' class="right_panel_win" style0="display:none">
        <div id="tab_title"
             style="position: absolute;left:10px;top:3px;width:145px;font-size: 18px;border:0px solid;color:#555555;"></div>
        <div class="right_tab">
            <ul style="white-space: nowrap;"><span
                    style="left:5px;top:-10px;position:relative;border:0px solid;display: inline-block;width:156px"></span>
            </ul>
            <div>
...
<div id="toolbar_basic" class="toolbox" style="color:#a7cf28">
    ...
    <i id="hide_status_all" class="fa fa-angle-double-up fa-2x" onclick="rt_show_hide_status(false)"
       title="Hide all status"></i>
    <i id="show_status_all" class="fa fa-angle-double-down fa-2x" onclick="rt_show_hide_status(true)"
       title="Show all status"></i>
    &nbsp;&nbsp;
    <i id="rt_flow_start" class="fa fa-play fa-2x" onclick="rt_flow_start_stop(true)" title="Start Flow"></i>
    <i id="rt_flow_stop" class="fa fa-stop fa-2x" style="color:red;" onclick="rt_flow_start_stop(false)"
       title="Stop Flow"></i>
</div>
...
<div id="cont_props" class="sub_win"
     style="top:80px;width:350px;bottom:10px;overflow: auto;display:none;position: absolute;">
...
<script>
    ...
    function init_right() {
        $(".right_tab").tab({
            on_selected_tab: (tbid) => {
                let title = "";
                switch (tbid) {
                    case 'lb_tab_i':
                        title = `<i class="fa fa-info fa-lg"></i> Info`;
                        break;
                    case 'lb_tab_help':
                        title = `<i class="fa fa-question fa-lg"></i> Help`;
                        break;
                    case 'lb_tab_lib':
                        title = `<i class="fa fa-book fa-lg"></i> Library`;
                        break;
                }
        ...
        $('.right_tab').tab('addTab', {
            'title': `<i class="fa fa-question fa-lg"></i>`,
            'id': 'lb_tab_help',
            'content': `<iframe id="right_help_iframe" src="" style="width:100%;top:0px;height:300px;overflow:hidden;margin: 0px;border:0px solid;padding: 0px;" ></iframe>`
        });
        $('.right_tab').tab('addTab', {
            'title': `<i class="fa fa-book fa-lg"></i>`,
            'id': 'lb_tab_lib',
            'content': `<iframe id="right_lib_iframe" src="" style="width:100%;top:0px;height:300px;overflow:hidden;margin: 0px;border:0px solid;padding: 0px;" ></iframe>`
        });
