...
<div class="mid" id="mid">
    <button id="conn_btn" style="z-index:10;position: absolute;display:none;" onclick="set_or_unset_conn()">Set Map
    </button>
</div>
<div class="right">
    <div class="tt" id="">
        <select id="taglist_cat" onchange="on_taglist_cat_chg()">
            ...
            %>
            <option value="<%=nt.getName() %>"><%=nt.getTitle() %>
            </option>
            <%
                }
            %>
