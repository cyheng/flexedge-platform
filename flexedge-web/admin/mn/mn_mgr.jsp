...
<div style="overflow:auto;">
    ...
    <span class="lib_item btn_sh_c" style="<%=borderc%>" title="<%=tt%>">
		<i class="fa fa-code-fork fa-lg fa-rotate-90"></i> &nbsp;<a class="text title"
                                                                    href="javascript:open_net('<%=net.getId()%>','<%=net.getTitle() %>')"><%=net.getTitle() %></a>
    ...
    %>
    <span class="lib_item" onclick="add_or_edit_flow()"><span class="bitem"><i class="fa-solid fa-plus fa-lg"
                                                                               style="top:10px;"></i></span></span>
</div>
<script>
    ...
    function flow_del(id) {
        dlg.confirm('<w:g>del,this,flow</w:g>?', {
