...
<%@ page import="
	cn.doraro.flexedge.core.*,
                 ...
                 cn.doraro.flexedge.driver.common.modbus.*,
                 cn.doraro.flexedge.pro.modbuss.*,
                 java.io.*,
                 java.util.*,
                 java.net.*,
                 java.util.*" %>
...
<form class="layui-form" action="">
    <div class="layui-form-item">
                ...
                <%
                    for (ModbusCmd.Protocol pts : ModbusCmd.Protocol.values()) {
                        if (pts == ModbusCmd.Protocol.tcp)
                            continue;
                %>
                <option value="<%=pts.name()%>"><%=pts.name()%>
                </option>
                <%
                    }
                %>
        ...
        <div class="layui-input-inline" style="width: 150px;">
            <input type="checkbox" id="enable" name="enable" checked lay-skin="switch" lay-filter="enable"
                   class="layui-input">
        </div>
    </div>
