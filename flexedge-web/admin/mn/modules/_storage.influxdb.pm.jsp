...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 400px;">
        <input type="checkbox" id="using_sor" name="using_sor" lay-filter="using_sor" autocomplete="off"
               class="layui-input">
    </div>
</div>
<div class="layui-form-item" id="is_sor">
    ...
    <div class="layui-input-inline" style="width: 400px;">
        <select id="sor_name" name="sor_name">
            ...
            %>
            <option value="<%=sor.getName() %>"><%=sor.getTitle() %> - <%=sor.getName() %>
            </option>
            <%
                }
            %>
...
<div id="not_sor" style="display:none">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 400px;">
            <input type="text" id="url" name="url" value="" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 400px;">
            <input type="text" id="token" name="token" value="" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 200px;">
            <input type="text" id="org" name="org" value="" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
        <div class="layui-form-mid">Bucket:</div>
        <div class="layui-input-inline" style="width: 200px;">
            <input type="text" id="bucket" name="bucket" value="" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
</div>
