...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 70px;">
        <input type="number" id="port" name="port" value="" lay-verify="required" autocomplete="off"
               class="layui-input">
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 70px;">
        ...
        <input type="number" id="keep_intv" name="keep_intv" value="" title="seconds" autocomplete="off"
               class="layui-input">
    </div>
