...
Devices
<button class="layui-btn layui-btn-sm layui-btn-primary" onclick="add_edit_dev()">+</button>
<div class="dev_list" id="dev_list">

</div>
Connector
<button class="layui-btn layui-btn-sm layui-btn-primary" onclick="add_cp_sel()">+</button>
