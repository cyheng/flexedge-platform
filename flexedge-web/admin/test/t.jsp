...
<div class="layout ">
    ...
    <div class="mid">
        <div id="main_panel" style="border: 0px solid #000; width: 100%; height: 100%; background-color: #1e1e1e">
            ...
            <div id="win_act1" class="oc-toolbar" style="display: none;width:;z-index:1">
                ...
                <div class="btns">
                    ...
                    <div title="线条" cmd="draw(polyline)" icon="icon-eda-line"
                         class="toolbarbutton icon-eda-line" data-i18n-attr="title">ab
                    </div>
            ...
            <div id="win_conn"
                 style="position: absolute; display: none; background-color: #cccccc">conn
            </div>
        </div>
    </div>
...
<div id='edit_panel'
    ...
    <div
        ...
        <input class="layui-btn layui-btn-primary layui-btn-sm" name='save' type='button' value='新建'
               onclick="add_new()" title="ctrl+n"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input class="layui-btn layui-btn-primary layui-btn-sm" name='save' type='button' value='保存'
               onclick="btn_save()" title="ctrl+b"/>
        <input class="layui-btn layui-btn-primary layui-btn-sm" name='load' type='button' value='装载'
               onclick="btn_load()" title="ctrl+b"/>
        <input class="layui-btn layui-btn-primary layui-btn-sm" name='load' type='button' value='装载Unit'
               onclick="btn_load_unit()" title="ctrl+b"/>
        <input class="layui-btn layui-btn-primary layui-btn-sm" name='load' type='button' value='Fit Win'
               onclick="draw_fit()" title="ctrl+b"/>
