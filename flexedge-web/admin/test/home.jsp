...
<%@page import="cn.doraro.flexedge.system.*,
    ...
    <div class="layui-field-box">
        ...
        <div class="dashboard-stats">
            <div class="dashboard-stats-item" style="background-color: #8775a7; margin-right: 0px;"
                 onclick="OpenNav('ce445861-579c-4f52-9d7a-5e783715d82d');">
    ...
    <div class="layui-field-box">
        ...
        <div class="dashboard-stats">
            <div class="dashboard-stats-item" style="background-color: #578ebe;" onclick="">
                ...
                <h5><span onclick="down_geojson()">下载GeoJSON</span>&nbsp;&nbsp;<span
                        onclick="down_shp()">下载shp</span></h5>
            </div>
        </div>
