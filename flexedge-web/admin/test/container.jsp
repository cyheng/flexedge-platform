...
<div class="layout ">
    ...
    <div class="right " style="background-color: #dddddd">
        ...
        <div id='edit_panel'
             style="border:1;font:15;position: absolute;top:3;width:99%;height:100%;right:3px;background-color:window;z-index: 60000;overFlow0:auto">
            ...
            <div style="background-color: silver;border: 1;border-bottom-style: outset;margin: 1">
                ...
                <input id='zoom_val' type='text' size=3 value='1'/><input type=button value='放大缩小'
                                                                          onclick='zoom_chg()'/>
