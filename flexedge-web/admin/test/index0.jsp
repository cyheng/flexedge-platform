...
<%@ page import="
	cn.doraro.flexedge.user.*,
                 ...
                 cn.doraro.flexedge.system.xmldata.*,
                 cn.doraro.flexedge.biz.*,
                 cn.doraro.flexedge.system.gdb.*" %>
...
<div id="win_act1" class="oc-toolbar" style="width:100%;top:70px;bottom: 50px;overflow:auto">
    <div id="main" class="btns" style="top:70px;width:100%">
        ...
        <div class="toolbarbtn" style="background-color: #515658" onclick="open_rep('<%=cid%>')">
            ...
            <div style="height:50px;margin:12px;color:#8dcef7"><%=tt %>
            </div>
        </div>
        <%
            }
        ...
        <div class="toolbarbtn" style="background-color: #515658" onclick="add()">
            <div style="background-color: #aaaaab;width:100%;height:170px;align-content: center;"><br><i
                    class="fa fa-plus-circle fa-3x"></i></div>
