...
public class ProcessUtil {
    ...
    private static ProItemWin parseFrom(String str) {// flexedge win panel.exe 27060 Console 1 32,656 K
...
//			try
//			{
//				//String cmd = javaf.getCanonicalPath()+" -cp "+bdir+File.separator+"lib"+File.separator+"* cn.doraro.flexedge.core.util.ProcessUtil "+SN_SERVICE_MON+" > "+logf.getCanonicalPath() ;
//				String cmd = javaf.getCanonicalPath();
//				String pm = " -cp "+bdir+File.separator+"lib"+File.separator+"* cn.doraro.flexedge.core.util.ProcessUtil "+SN_SERVICE_MON +" > "+logf.getCanonicalPath() ;
