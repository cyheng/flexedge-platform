...
import cn.doraro.flexedge.core.store.gdb.xorm.XORMClass;
...
import cn.doraro.flexedge.core.store.tssdb.TSSValPtEval;
import cn.doraro.flexedge.core.store.tssdb.TSSValSeg;
...
public class RecProL1DValue extends RecProL1 implements ILang {
    ...
    protected boolean RT_onTagSegsSaved(TSSSavePK savepk) throws Exception {
        ...
        long startdt = -1;
        if (lastob == null) {//first time to record,需要往前回溯
...
//	{
//		return "/_flexedge/res/dvalue.png" ;
//	}
}
