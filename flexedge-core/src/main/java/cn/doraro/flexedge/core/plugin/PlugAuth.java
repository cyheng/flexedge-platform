...
public class PlugAuth {
    ...
    //public static final String PN_IOTTREE_TOKEN = "flexedge_token" ;
    ...
    /**
     * this method will be called when outer will access node path in flexedge like /prjname/n1/u1
     * <p>
    ...
    /**
     * this method will be called when outer will write some data to node path in flexedge like /prjname/n1/u1
     * <p>
