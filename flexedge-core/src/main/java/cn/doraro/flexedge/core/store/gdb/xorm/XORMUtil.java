package cn.doraro.flexedge.core.store.gdb.xorm;

import cn.doraro.flexedge.core.store.gdb.DataColumn;
import cn.doraro.flexedge.core.store.gdb.DataRow;
import cn.doraro.flexedge.core.store.gdb.DataTable;
import cn.doraro.flexedge.core.store.gdb.autofit.DbSql;
...
public class XORMUtil {
    ...
    private static void listXORMPropFields(Class<?> c, ArrayList<Field> fs, IXORMPropFilter filter) {
        ...
        if (xormc != null && xormc.inherit_parent()) {//�Ӹ�������ȡ
...
//						new Class<?>[] { m.getReturnType() });
    ...
    private static void setMethodVal(Object o, Method tmpm, Object ov)
        ...
        if (mc == Boolean.class || mc == boolean.class) {// ��bool��������⴦��,ʹ֮�ܹ���Ӧ����
    ...
    private static void setFieldVal(Object o, Field f, Object ov)
        ...
        if (fc == Boolean.class || fc == boolean.class) {// ��bool��������⴦��,ʹ֮�ܹ���Ӧ����
            if (ov instanceof Number) {
                f.setBoolean(o, ((Number) ov).intValue() > 0);
            } else if (ov instanceof String) {//for derby err
