...
import cn.doraro.flexedge.core.util.xmldata.XmlHelper;
...
//							.getRequest());
        ...
        if (realp == null && p.startsWith("/")) {// tomato��ʽ��,ͨ��ȫ������
    ...
    public static Element loadConf() {
        ...
        synchronized (locker) {
            ...
            try {
                ...
                System.setProperty("flexedge.data_dir", getDataDirBase());
                System.setProperty("flexedge.msg_net", getDataDirBase() + "/msg_net/");
                System.setProperty("flexedge.lib_plugins.dir", getDataDirBase() + "/plugins/");
                ...
                System.setProperty("flexedge.data_dyn_dir", dataDynDirBase);
                ...
                if (!tmpdir.exists())
                    tmpdir.mkdirs();
                System.setProperty("flexedge.tmp_dir", getDataDirBase() + "/tmp/");
...
//		System.setProperty("java.class.path", sb.toString()) ;
    ...
    public static Element getConfElement(String name) {
        ...
        if (nl == null || nl.getLength() <= 0) {//try load debug
            re = loadConfDebug();
            if (re != null)
    ...
    public static String getVersion() {
        if (version != null)
            return version;
        try {
            String res = "META-INF/maven/cn.doraro.flexedge/flexedge-core/pom.properties";
