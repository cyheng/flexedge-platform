...
public class DataRow extends HashMap<String, Object> implements IXmlDataable {
    ...
    static Object prepareObjVal(Object o) {
        ...
        if ((o instanceof java.util.Date)
            ...
            return new Timestamp(((java.util.Date) o)
                    .getTime());
        }
    ...
    public void putValue(String colname, Object ov) {
        if (ov != null) {
            if ((ov instanceof java.util.Date)
                    && !(ov instanceof Timestamp)) {//Ϊ����Ӧjdbc�������ݿ��Ҫ�󣬰�Date�ĳ�Timestamp
                ov = new Timestamp(((java.util.Date) ov)
                        .getTime());
            }
        ...
        try {
            ...
            for (int i = 0; i < colnames.length; i++) {
                ...
                if (tmpo != null) {
                    ...
                    if (sqlt == Types.BLOB)// for sqlserver driver
                        // NullPointer error
