...
//	}
    ...
    synchronized public void start() {
        ...
        bRun = true;
        thread = new Thread(this, "flexedge-MsgCmdEndPoint");
        thread.start();
    }
...
//	 }
    ...
    private void fireCmdRecved(MCmdAsyn mca) {
        if (this.statM != null) {
            ...
            try {
                if (mca.isAckCmd()) {//特殊处理ack命令
                    if (statM instanceof IAckListener) {//注意，IAckListener必须由StateM实现
