...
import cn.doraro.flexedge.core.cxt.*;
import cn.doraro.flexedge.core.msgnet.MNBase.DivBlk;
import cn.doraro.flexedge.core.msgnet.MNCxtVar.KeepTP;
import cn.doraro.flexedge.core.util.Convert;
import cn.doraro.flexedge.core.util.JsonUtil;
...
public class MNCxtPk extends JSObMap implements IMNCxtPk {
    ...
    public HashSet<String> CXT_getVarNameSet() {//copy new set
        HashSet<String> rets = new HashSet<>();
        rets.addAll(name2var.keySet());
        return rets;
    }

    public List<String> CXT_getVarNamesAll() {//copy new set
