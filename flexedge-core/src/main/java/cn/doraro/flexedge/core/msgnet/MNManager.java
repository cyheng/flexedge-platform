...
import cn.doraro.flexedge.core.msgnet.modules.ConnInMsg_M;
import cn.doraro.flexedge.core.msgnet.modules.ConnMsgIn_NS;
...
import cn.doraro.flexedge.core.msgnet.nodes.NS_TagEvtTrigger;
import cn.doraro.flexedge.core.msgnet.nodes.NS_TagValChgTrigger;
import cn.doraro.flexedge.core.msgnet.nodes.OutCallFunc;
import cn.doraro.flexedge.core.msgnet.store.evt_alert.EvtAlertTb;
...
public class MNManager {
    ...
    static {
        String msgnetdir = System.getProperty("flexedge.msg_net");
        if (Convert.isNullOrEmpty(msgnetdir))
            throw new RuntimeException("no [flexedge.msg_net] env property found");
...
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.ManualTrigger(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NS_TimerTrigger(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NE_Debug(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_MemQueue(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.modules.MemMultiQueue(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NS_OuterTrigger(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NS_OnFlowEvt(),cat) ;
//		
//		cat = registerCat(new MNCat("_func")) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_JsFunc(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_Template(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_Change(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_Switch(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_OnOff(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_PID(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_Exec(),cat) ;
//		
//		cat = registerCat(new MNCat("_dev")) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_TagReader(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_TagWriter(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_TagFilter(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_TagFilterW(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NS_TagValChgTrigger(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NS_TagEvtTrigger(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NS_ConnInMsgTrigger(),cat) ;
//		//registerItem(new NS_TagAlertTrigger(),cat) ;
//		
//		
//		cat = registerCat(new MNCat("_net")) ;
//		registerItem("cn.doraro.flexedge.ext.msg_net.Kafka_M",cat) ;
//		registerItem("cn.doraro.flexedge.ext.msg_net.Mqtt_M",cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_HttpClient(),cat) ;
//		registerItem("cn.doraro.flexedge.ext.msg_net.BACnet_M",cat) ;
//		
//		
//		cat = registerCat(new MNCat("_storage")) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_FileReader(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.nodes.NM_FileWriter(),cat) ;
//		registerItem(new cn.doraro.flexedge.core.msgnet.modules.DBSql(),cat) ;
//		registerItem("cn.doraro.flexedge.ext.msg_net.InfluxDB_M",cat) ;
//		
//		cat = registerCat(new MNCat("_sim")) ;
//		registerItem("cn.doraro.flexedge.pro.modbuss.MSBus_M",cat) ;
//
//	}
