...
class HLModel_CJ2 extends HLModel {
    public HLModel_CJ2() {
        super("cj2", "CJ2");
        this.setAddrDef(new HLAddrDef("A").asValTpSeg(new HLAddrSeg("R", 0, 447, 3, new UAVal.ValTP[]{UAVal.ValTP.vt_int16, UAVal.ValTP.vt_uint16}).asWrite(false).asHasSubBit(true)).asValTpSeg(new HLAddrSeg("R", 0, 446, 3, new UAVal.ValTP[]{UAVal.ValTP.vt_int32, UAVal.ValTP.vt_uint32, UAVal.ValTP.vt_float}).asWrite(false).asHasSubBit(false)).asValTpSeg(new HLAddrSeg("RW", 448, 1471, 4, new UAVal.ValTP[]{UAVal.ValTP.vt_int16, UAVal.ValTP.vt_uint16}).asWrite(true).asHasSubBit(true)).asValTpSeg(new HLAddrSeg("RW", 448, 1470, 4, new UAVal.ValTP[]{UAVal.ValTP.vt_int32, UAVal.ValTP.vt_uint32, UAVal.ValTP.vt_float}).asWrite(true).asHasSubBit(false)).asValTpSeg(new HLAddrSeg("R", 10000, 11535, 5, new UAVal.ValTP[]{UAVal.ValTP.vt_int16, UAVal.ValTP.vt_uint16}).asWrite(false).asHasSubBit(true)).asValTpSeg(new HLAddrSeg("R", 10000, 11534, 4, new UAVal.ValTP[]{UAVal.ValTP.vt_int32, UAVal.ValTP.vt_uint32, UAVal.ValTP.vt_float}).asWrite(false).asHasSubBit(false)));
        ...
        this.setAddrDef(new HLAddrDef("TK").asValTpSeg(new HLAddrSeg("IO", 0, 127, 3, new UAVal.ValTP[]{UAVal.ValTP.vt_bool}).asWrite(false).asHasSubBit(false)));
